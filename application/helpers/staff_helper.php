...
function get_available_staff_permissions($data = [])
{
    ...
    $corePermissions = [
        ...
        'invoices' => [
			'name'         => _l('invoices'),
			'capabilities' => array_merge($allPermissionsArray, ['sales_menu' => _l('sales_menu')]),
		],
        'utilities' => [
            'name'         => _l('utilities'),
            'capabilities' => $allPermissionsArray,
    ...
    if ($addLeadsPermission) {
		$corePermissions['leads'] = [
			...
			'capabilities' => [
				...
				'edit'      => _l('permission_edit'),
				'delete'    => _l('permission_delete'),
				'print_lead'    => _l('print_lead'),
				'export'    => _l('export'),
				'bulk_action'    => _l('bulk_action'),
			],
			'help' => [
				'view'      => _l('help_leads_permission_view'),
				'view_own'  => _l('help_leads_permission_view_own'),
				'create'    => _l('help_leads_permission_create'),
				'edit'      => _l('help_leads_permission_edit'),
				'delete'    => _l('help_leads_permission_delete'),
			],
		];
	}
...
function get_patient_name($client_id)
{
    $CI =& get_instance();
