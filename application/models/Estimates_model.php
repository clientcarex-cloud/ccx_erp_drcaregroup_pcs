...
class Estimates_model extends App_Model
{
    ...
    public function convert_to_invoice($id, $client = false, $draft_invoice = false)
    {
        ...
        $new_invoice_data['duedate']    = $_estimate->expirydate;
        ...
        $new_invoice_data['appointment_type_id'] = $_estimate->appointment_type_id;
        $new_invoice_data['branch_id']        = $_estimate->branch_id;
