                        ...
                        if ($isKanBan) { ?>
                            ...
                            <div class="row" id="leads-table">
                              ...
                              $table_data    = [];
								...
								$_table_data[] = [
                                    'name'     => _l('lead_gender'),
                                    'th_attrs' => ['class' => 'toggleable', 'id' => 'th-lead_gender'],
                                ];
								$_table_data[] = [
                                    'name'     => _l('leads_treatment'),
                                    'th_attrs' => ['class' => 'toggleable', 'id' => 'th-leads_treatment'],
                                ];
								$_table_data[] = [
								...
								$_table_data[] = [
                                    'name'     => _l('lead_priority'),
                                    'th_attrs' => ['class' => 'toggleable', 'id' => 'th-lead_priority'],
                                ];
								
								$_table_data[] = [
                                    'name'     => _l('lead_add_edit_assigned'),
                                    'th_attrs' => ['class' => 'toggleable', 'id' => 'th-lead_add_edit_assigned'],
                                ];
								$_table_data[] = [
								...
								$_table_data[] = [
                                    'name'     => _l('called_date'),
                                    'th_attrs' => ['class' => 'toggleable', 'id' => 'th-called_date'],
                                ];
                               ...
                               /*  $_table_data[] = [
                                ...
                                $_table_data[] = [
                                    ...
                                    'th_attrs' => ['class' => 'date-followup_date toggleable', 'id' => 'th-followup_date'],
                                ];
...
<script>
     var disableLeadsExport = <?php echo staff_can('export', 'leads') ? 'false' : 'true'; ?>;
    var disableLeadsBulk = <?php echo staff_can('bulk_action', 'leads') ? 'false' : 'true'; ?>;
	$(function () {
    var $leadsTable = $('#leads');

    $leadsTable.on('init.dt', function () {
        var $buttons = $leadsTable.closest('.dataTables_wrapper').find('.dt-buttons button');

        if (disableLeadsExport) {
            $buttons.filter(function () {
                return $(this).text().trim().toLowerCase() === 'export';
            }).remove();
        }

        if (disableLeadsBulk) {
            $buttons.filter(function () {
                return $(this).text().trim().toLowerCase() === 'bulk actions';
            }).remove();
        }
    });
});
