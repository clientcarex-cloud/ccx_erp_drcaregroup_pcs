      ...
      foreach ($custom_fields as $field) {
          ...
          if ($value == '') {
              ...
              if (!in_array($c_field, $not_mergable_contact_fields)) {
                ...
                <input type="hide" class="fake-autofill-field" name="fakepasswordremembered" value='123456'
                    tabindex="-1" />-->
                <!--<div class="client_password_set_wrapper">
                    <label for="password" class="control-label"><?php echo _l('client_password'); ?></label>
                    <div class="input-group">
                        <input type="hide" class="form-control password" name="password" value="123456" autocomplete="off">
