...
<div id="wrapper">
    ...
    <!-- Optional: Move this into the header if needed -->
    <div class="screen-options-wrapper" style="position: absolute; top: 25px; right: 20px; z-index: 1000;">
        <div class="screen-options-btn d-flex align-items-center cursor-pointer">
