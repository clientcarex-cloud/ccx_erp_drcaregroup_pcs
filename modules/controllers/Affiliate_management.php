...
class Affiliate_management extends AdminController
{
    ...
    function index()
    {
        ...
        if (!staff_can('view', AFFILIATE_MANAGEMENT_MODULE_NAME)) {
    ...
    {
        // Check for permission
        if (!staff_can('create', AFFILIATE_MANAGEMENT_MODULE_NAME)) {
            return access_denied(AFFILIATE_MANAGEMENT_MODULE_NAME);
        }
    ...
    {
        // Check for permission
        if (!staff_can('delete', AFFILIATE_MANAGEMENT_MODULE_NAME)) {
            return access_denied(AFFILIATE_MANAGEMENT_MODULE_NAME);
        }
    ...
    public function assign_client_affiliate()
    {
        ...
        try {
            ...
            if (!$this->affiliate_management_model->add_referral($data))
