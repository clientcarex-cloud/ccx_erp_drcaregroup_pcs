					...
					<div class="panel-body">
						...
						<div class="btn-group pull-right mleft4 btn-with-tooltip-group" data-toggle="tooltip" data-title="<?php echo _l('si_lf_filter_templates'); ?>" data-original-title="" title="">
							...
							if(!empty($filter_templates))
							{
								...
								{
									echo "<li><a href='leads_filter?filter_id=$row[id]'>".($row['is_default']? "<i class='fa fa-star'></i> ":"")."$row[filter_name]</a></li>";
								}
							}
							else
						...
						<a href="leads_filter" class=" pull-right btn btn-info mleft4" data-toggle="tooltip" data-title="<?php echo _l('si_lf_new_info'); ?>"><?php echo _l('si_lf_new'); ?></a>
						<a href="<?php echo admin_url('si_lead_filters/switch_kanban/' . $switch_kanban); ?>"
						...
						<div class="panel-body">
							<div class="active kan-ban-tab" id="kan-ban-tab" style="overflow:auto;">
								<div class="kanban-leads-sort">
                                    ...
                                    <a href="#" onclick="si_leads_kanban_sort('dateadded'); return false"
                                        class="dateadded">
                                    ...
                                    |
                                    <a href="#" onclick="si_leads_kanban_sort('leadorder');return false;"
                                        class="leadorder">
                                    ...
                                    |
                                    <a href="#" onclick="si_leads_kanban_sort('lastcontact');return false;"
                                        class="lastcontact">
