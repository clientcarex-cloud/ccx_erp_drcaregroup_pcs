						...
						<table class="table dt-table scroll-responsive">
							...
							if(!empty($filter_templates)){
								...
								<tr class="has-row-options">
									<td><?php echo ($i++);?></td>
									<td data-order="<?php echo e($row['filter_name']); ?>">
										<a href="leads_filter/?filter_id=<?php echo e($row['id']);?>"><?php echo ($row['is_default']? "<i class='fa fa-star'></i> ":"") . e($row['filter_name']); ?></a>
										<div class="row-options">
										<a href="leads_filter/?filter_id=<?php echo e($row['id']);?>"><?php echo _l('edit');?></a> | <a href="del_lead_filter/<?php echo e($row['id']);?>" class="confirm text-danger"><?php echo _l('delete');?></a>
										</div>
									</td>
								</tr>
								<?php } }?>
