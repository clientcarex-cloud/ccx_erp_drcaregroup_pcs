...
<div class="modal fade" id="client-model-auto" tabindex="-1" role="dialog">
              ...
              if ($callback_url) {
                if ($should_close_tab) {
                  ...
                  if ($callback_url == "appointments-tab") {
                    ...
                    ?>
                    <?php
                    // If callback_url starts with a module name (contains '/'), use it directly
                    // Otherwise, prepend 'client/' for backward compatibility
                    $close_url = (strpos($callback_url, '/') !== false) ? admin_url($callback_url) : admin_url('client/' . $callback_url);
                    ?>
                    <a href="<?= $close_url; ?>">
                      <button type="button" class="btn btn-secondary btn-sm close close-button">
                        <span aria-hidden="true">&times;</span>
          ...
          <div class="modal-body">
            <div class="top-lead-menu">
              <div class="horizontal-scrollable-tabs tw-mb-10">
                ...
                <div class="scroller arrow-right" style="display: block !important;"><i class="fa fa-angle-right"></i>
                </div>
                ...
                <div class="horizontal-tabs">
                  <ul class="nav nav-tabs nav-tabs-horizontal nav-tabs-segmented" role="tablist">
                    ...
                    if (staff_can('view_patient_reminders', 'customers')) {
                      ?>
                      <li role="presentation">
                        <a href="#patient_reminders" aria-controls="patient_reminders" role="tab" data-toggle="tab">
            ...
            <div class="tab-content">
             ...
             font-size: 14px;">
                    ...
                    <table class="patient-table">
                      <tr>
                        <td><span class="patient-value"><strong><?= _l('mr_no'); ?>:</strong>
                            <?= $customer_new_fields->mr_no; ?></span></td>
                        <td><span class="patient-value"><strong><?= _l('city_state_country'); ?>:</strong>
                            <?= $client->city_name; ?>, <?= $client->state_name; ?></span></td>
                      </tr>
                      <tr>
                        <td><span class="patient-value"><strong><?= _l('patient_name'); ?>:</strong>
                            <?= $client->company; ?></span></td>
                        <td><span class="patient-value"><strong><?= _l('pincode'); ?>:</strong>
                            <?= $client->pincode_name; ?></span></td>
                      </tr>
                      <tr>
                        <td><span class="patient-value"><strong><?= _l('age'); ?>:</strong>
                            <?= $customer_new_fields->age; ?></span></td>
                        <td><span class="patient-value"><strong><?= _l('gender'); ?>:</strong>
                            <?= $customer_new_fields->gender; ?></span></td>
                      </tr>
                      <tr>
                        ...
                        <td><span class="patient-value"><strong><?= _l('marital_status'); ?>:</strong>
                            <?= $client->marital_status; ?></span></td>
                      </tr>
                      <tr>
                        <td><span class="patient-value"><strong><?= _l('email_id'); ?>:</strong>
                            <?= $client->email_id; ?></span></td>
                        <td><span class="patient-value"><strong><?= _l('language_known'); ?>:</strong>
                            <?= $client->default_language; ?></span></td>
                      </tr>
                      <tr>
                        <td><span class="patient-value"><strong><?= _l('area'); ?>:</strong> <?= $client->area; ?></span>
                        </td>
                        <td><span class="patient-value"><strong><?= _l('lead_source'); ?>:</strong>
                            <?= $client->source_name ?? ''; ?></span></td>
                      </tr>
                      <tr>
                        <td><span class="patient-value"><strong><?= _l('address'); ?>:</strong>
                            <?= $client->address; ?></span></td>
                        <td>
                      ...
                      <?php if ($total_estimates > 1): ?>
                        <tr>
                          <td><span class="patient-value"><strong><?= _l('renewal_start_date'); ?>:</strong>
                              <?= $renewal_start_date ? _d($renewal_start_date) : '-'; ?></span></td>
                          <td><span class="patient-value"><strong><?= _l('renewal_end_date'); ?>:</strong>
                              <?= $renewal_end_date ? _d($renewal_end_date) : '-'; ?></span></td>
                        </tr>
                      <?php else: ?>
                        <tr>
                      ...
                      <tr>
                        ...
                        <td><span class="patient-value"><strong><?= _l('doctor'); ?>:</strong>
                            <?= get_staff_full_name($latest_doctor_id); ?></span></td>
                      </tr>
                      <tr>
                        ...
                        if ($total_package > 0) {
                          ...
                          <table class="patient-table">
                            ...
                            <tr>
                              ...
                              <td>
                                <span class="patient-value">
                                  <span class="patient-value"><strong><?= _l('total_package'); ?>:</strong>
                                    <?= app_format_money_custom($total_package, $currency); ?></span>
                                </span>
                              </td>
                              <td>
                                <span class="patient-value">
                                  <span class="patient-value"><strong><?= _l('total_paid'); ?>:</strong>
                                    <?= app_format_money_custom($total_paid, $currency); ?></span>
                                </span>
                              </td>
                            ...
                            <tr>
                              <td>
                                <span class="patient-value">
                                  <span class="patient-value"><strong><?= _l('total_dues'); ?>:</strong>
                                    <?= app_format_money_custom($total_dues, $currency); ?></span>
                                </span>
                              </td>
                            ...
                            <tr>
                              ...
                              <td>
                                <span class="patient-value">
                                  ...
                                  <?= app_format_money_custom($latest_summary['total'], $currency); ?>
                                </span>
                              </td>
                              <td>
                                <span class="patient-value">
                                  <strong><?= _l('total_paid'); ?>:</strong>
                                  <?= app_format_money_custom($latest_summary['paid'], $currency); ?>
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span class="patient-value">
                                  ...
                                  <?= app_format_money_custom($latest_summary['dues'], $currency); ?>
                                </span>
                              </td>
                              <td><span class="patient-value"><strong><?= _l('cob_with_refund'); ?>:</strong> -</span></td>
                              <td><span class="patient-value"><strong><?= _l('normal_refund'); ?>:</strong> -</span></td>
      ...
      <td>
        ...
        <br></div>`;
            ...
            <?= _l('add_casesheet'); ?>
                ...
                <a href="<?= admin_url('client/add_casesheet/' . $client->userid); ?>" target="_blank"><button
                    class="btn btn-primary btn-sm" style="float: right; margin-top: 6px; margin-right: 5px;">
                    <?= _l('add_casesheet'); ?>
                  </button></a>
                <?php
                } ?>
                  ...
                  <form id="casesheetForm">
                    ...
                    <div class="accordion" id="casesheetAccordion">
                      ...
                      <div class="card">
                        ...
                        <button class="btn <?php echo $isOpen ? '' : 'collapsed'; ?>" type="button"
                          data-toggle="collapse" data-target="#collapsePreliminaryData"
                          aria-expanded="<?php echo $isOpen ? 'true' : 'false'; ?>"
                          aria-controls="collapsePreliminaryData" style="width: 100%">
                        ...
                        <div id="collapsePreliminaryData" class="<?php echo $isOpen ? 'show' : ''; ?>"
                          aria-labelledby="headingPreliminaryData" data-parent="#casesheetAccordion">
                              ...
                              <div id="treatment_rows">
                                ...
                                <div class="row treatment-row align-items-end mb-3">
                                  ...
                                  <div class="col-md-2">
                                    ...
                                    <input type="number" name="duration_value" class="form-control" min="1"
                                      placeholder="Number" value="<?= htmlspecialchars($duration_value) ?>">
                ...
                <div class="col-md-1">
                    <button type="button" class="btn btn-danger remove-row"><i class="fa fa-minus"></i> </button>
                            ...
                            <div class="form-group mtop20">
                              ...
                              <textarea id="presenting_complaints" name="presenting_complaints"
                                class="form-control tinymce"
                                rows="6"> <?php //isset($casesheet_data['presenting_complaints']) ? htmlspecialchars($casesheet_data['presenting_complaints']) : '' ?></textarea>
                            </div>
                            ...
                            <div class="form-group mtop20">
                              ...
                              <textarea id="complaint" name="complaint" class="form-control tinymce"
                                rows="6"> <?php //isset($casesheet_data['complaint']) ? htmlspecialchars($casesheet_data['complaint']) : '' ?></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="card">
                        <button class="btn collapsed" type="button" data-toggle="collapse"
                          data-target="#collapseClinicalObservation" aria-expanded="false"
                          aria-controls="collapseClinicalObservation" style="width: 100%">
                          <div class="card-header" id="headingClinicalObservation">
                            <h5 class="mb-0">

                              <strong><?php echo _l('clinical_observation'); ?></strong> <i
                                class="fa fa-chevron-down toggle-icon" id="icon-clinicalObservation"></i>

                            </h5>
                          </div>
                        </button>
                        <div id="collapseClinicalObservation" class="<?php echo $isOpen ? 'show' : ''; ?>"
                          aria-labelledby="headingClinicalObservation" data-parent="#casesheetAccordion">
                          ...
                          <div class="card-body">
                            ...
                            <div class="row mtop10">
                              ...
                              <div class="col-md-12">
                                <label for="clinical_observation"><?php echo _l('clinical_observation'); ?> <span
                                    class="text-danger">*</span></label>
                                <textarea name="clinical_observation" id="clinical_observation"
                                  class="form-control tinymce"
                                  rows="6"><?php //isset($casesheet_data['clinical_observation']) ? htmlspecialchars($casesheet_data['clinical_observation']) : '' ?></textarea>
                              </div>
                            </div>
                      ...
                      <div class="card">
                        <button class="btn collapsed" type="button" data-toggle="collapse"
                          data-target="#collapsePersonalHistory" aria-expanded="false"
                          aria-controls="collapsePersonalHistory" style="width: 100%">
                          <div class="card-header" id="headingPersonalHistory">
                            <h5 class="mb-0">

                              <strong><?php echo _l('personal_history'); ?></strong> <i
                                class="fa fa-chevron-down toggle-icon" id="icon-personalHistory"></i>

                            </h5>
                          </div>
                        </button>
                        <div id="collapsePersonalHistory" class=" <?php echo $isOpen ? 'show' : ''; ?>"
                          aria-labelledby="headingPersonalHistory" data-parent="#casesheetAccordion">
                          <div class="card-body">
                            <div class="row">
                              ...
                              <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="desires" class="form-control"
                                  placeholder="<?= _l('desires'); ?>"
                                  value="<?= isset($casesheet_data['desires']) ? htmlspecialchars($casesheet_data['desires']) : '' ?>">
                              </div>

                              <div class="col-md-4 mb-3">
                                <label><?= _l('aversion'); ?>:</label>
                                <input type="text" name="aversion" class="form-control"
                                  placeholder="<?= _l('aversion'); ?>"
                              ...
                              <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="sun_headache" class="form-control"
                                  placeholder="<?= _l('sun_headache'); ?>"
                              ...
                              <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="thermals" class="form-control"
                                  placeholder="<?= _l('thermals'); ?>"
                              ...
                              <div class="col-md-4 mb-3">
                                ...
                                <textarea name="dreams" class="form-control"
                                  placeholder="<?= _l('dreams'); ?>"><?= isset($casesheet_data['dreams']) ? htmlspecialchars($casesheet_data['dreams']) : '' ?></textarea>
                              </div>
                              ...
                              <div class="col-md-4 mb-3">
                                ...
                                <textarea name="diabetes" class="form-control"
                                  placeholder="<?= _l('diabetes'); ?>"><?= isset($casesheet_data['diabetes']) ? htmlspecialchars($casesheet_data['diabetes']) : '' ?></textarea>
                              </div>

                              <div class="col-md-4 mb-3">
                                <br>
                                <label><?= _l('thyroid'); ?>:</label>
                                <textarea name="thyroid" class="form-control"
                                  placeholder="<?= _l('thyroid'); ?>"><?= isset($casesheet_data['thyroid']) ? htmlspecialchars($casesheet_data['thyroid']) : '' ?></textarea>
                              </div>

                              <div class="col-md-4 mb-3">
                                <br>
                                <label><?= _l('hypertension'); ?>:</label>
                                <textarea name="hypertension" class="form-control"
                                  placeholder="<?= _l('hypertension'); ?>"><?= isset($casesheet_data['hypertension']) ? htmlspecialchars($casesheet_data['hypertension']) : '' ?></textarea>
                              </div>
                              ...
                              <div class="col-md-4 mb-3">
                                ...
                                <textarea name="hyperlipidemia" class="form-control"
                                  placeholder="<?= _l('hyperlipidemia'); ?>"><?= isset($casesheet_data['hyperlipidemia']) ? htmlspecialchars($casesheet_data['hyperlipidemia']) : '' ?></textarea>
                              </div>

                              <div class="col-md-4 mb-3">
                                <br>
                                <label><?= _l('menstrual_obstetric_history'); ?>:</label>
                                <textarea name="menstrual_obstetric_history" class="form-control"
                                  placeholder="<?= _l('menstrual_obstetric_history'); ?>"><?= isset($casesheet_data['menstrual_obstetric_history']) ? htmlspecialchars($casesheet_data['menstrual_obstetric_history']) : '' ?></textarea>
                              </div>
                              ...
                              <div class="col-md-4 mb-3">
                                ...
                                <textarea name="family_history" class="form-control"
                                  placeholder="<?= _l('family_history'); ?>"><?= isset($casesheet_data['family_history']) ? htmlspecialchars($casesheet_data['family_history']) : '' ?></textarea>
                              </div>
                              ...
                              <div class="col-md-4 mb-3">
                                ...
                                <textarea name="past_treatment_history" class="form-control"
                                  placeholder="<?= _l('past_treatment_history'); ?>"><?= isset($casesheet_data['past_treatment_history']) ? htmlspecialchars($casesheet_data['past_treatment_history']) : '' ?></textarea>
                              </div>
                      ...
                      <div class="card">
                        <button class="btn collapsed" type="button" data-toggle="collapse"
                          data-target="#collapseGeneralExamination" aria-expanded="false"
                          aria-controls="collapseGeneralExamination" style="width: 100%">
                          <div class="card-header" id="headingGeneralExamination">
                            <h5 class="mb-0">
                              <strong><?php echo _l('general_examination'); ?></strong> <i
                                class="fa fa-chevron-down toggle-icon" id="icon-generalExamination"></i>

                            </h5>
                          </div>
                        </button>
                        <div id="collapseGeneralExamination" class="<?php echo $isOpen ? 'show' : ''; ?>"
                          aria-labelledby="headingGeneralExamination" data-parent="#casesheetAccordion">
                          <div class="card-body">
                            ...
                            <div class="row mtop15">
                              ...
                              <div class="col-md-4">
                                ...
                                <?php else: ?>
                                <textarea name="<?php echo $field; ?>" class="form-control" rows="2"
                                  placeholder="<?php echo $labels[$field]; ?>"></textarea>
                                <?php endif; ?>
                              </div>
                              <?php endforeach; ?>
                            </div>
                      ...
                      <!-- Mind Tab -->
                      <div class="card">
                        <button class="btn collapsed" type="button" data-toggle="collapse" data-target="#collapseMind"
                          aria-expanded="false" aria-controls="collapseMind" style="width: 100%">
                          <div class="card-header" id="headingMind">
                            <h5 class="mb-0">
                              <strong><?php echo _l('mind'); ?></strong> <i class="fa fa-chevron-down toggle-icon"
                                id="icon-mind"></i>

                            </h5>
                          </div>
                        </button>
                        <div id="collapseMind" class="<?php echo $isOpen ? 'show' : ''; ?>"
                          aria-labelledby="headingMind" data-parent="#casesheetAccordion">
                          <div class="card-body">
                            <!-- Mind Content -->
                            <div class="form-group mtop20">
                              ...
                              <textarea id="mind" name="mind" class="form-control tinymce"
                                rows="6"><?= isset($casesheet_data['mind']) ? htmlspecialchars($casesheet_data['mind']) : '' ?></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="card">
                        ...
                        <button class="btn collapsed" type="button" data-toggle="collapse"
                          data-target="#collapsePrescription" aria-expanded="false" aria-controls="collapsePrescription"
                          style="width: 100%">
                          <div class="card-header" id="headingPrescription">
                            <h5 class="mb-0">
                              <strong><?php echo _l('prescription'); ?></strong> <i
                                class="fa fa-chevron-down toggle-icon" id="icon-mind"></i>

                            </h5>
                          </div>
                        </button>
                        <div id="collapsePrescription" class="<?php echo $isOpen ? 'show' : ''; ?>"
                          aria-labelledby="headingPrescription" data-parent="#casesheetAccordion">
                          <div class="card-body">
  ...
  <tbody id="prescriptionMedicineBody">
    <tr>
      ...
      `;
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-4">
                                <label
                                  for="medicine_days"><?php echo _l('medicine_period') . '(In Days)'; ?><!-- <span class="text-danger">*</span> --></label>
                                <input type="number" name="medicine_days" id="medicine_days" class="form-control"
                                  min="1">
                              </div>
                              <div class="col-md-4">
                                <?PHP
                                ...
                                ?>
                                <label
                                  for="followup_date"><?php echo _l('followup_date') . ': (' . $medicine_followup_days . ' Days)'; ?></label>
              ...
              <div role="tabpanel" class="tab-pane" id="tab_estimation">
                ...
                <div class="table-responsive">
                  ...
                  if (staff_can('create_estimation', 'customers')) {
                    ?>
                  <button class="btn btn-primary btn-sm" onclick="toggleEstimationForm()"
                    style="float: right; margin-top: 6px; margin-right: 5px;">+<?php echo _l('add_package'); ?></button>
                  <?php
                  }
                  ?>
                  <!-- Title Section -->
                  ...
                  <div id="estimation-form" class="card p-3 mb-4" style="display: none; margin-top: -19px;">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <div id="durationInfo" class="alert alert-success" style="font-weight: 500;">
                        ✅ Dr.
                        <strong><?php echo $latest_casesheet_package->firstname . ' ' . $latest_casesheet_package->lastname; ?></strong>
                        has suggested a <strong><?php echo $latest_casesheet_package->duration_value; ?> months</strong>
                        package to heal the problem of
                        <strong><?php echo $latest_casesheet_package->treatment_name; ?></strong> for this patient.

                        Initially, Dr.
                        <strong><?php echo $latest_casesheet_package->firstname . ' ' . $latest_casesheet_package->lastname; ?></strong>
                        had given <strong><?php echo $latest_casesheet_package->medicine_days; ?> days</strong> of
                        medicine. Then follow-up visit will be there.
                      </div>
                    ...
                    <div class="col-md-12 form-group mt-3">
                      <div class="text-right">
                        ...
                        <!-- Styled Buttons -->
                        <label class="action-toggle-btn" for="actionCallback"
                          id="btnCallback"><?php echo _l('get_back'); ?></label>
                        <?PHP
                        $selected_duration = $latest_casesheet_package->duration_value ?? '';
                        if ($selected_duration > 0) {
                          ?>
                        <label class="action-toggle-btn" for="actionAddPackage"
                          id="btnAddPackage"><?php echo _l('add_package'); ?></label>
                        <?PHP
                        }
                        ?>
                      </div>
                    ...
                    <div id="callback-section" style="display: none; margin-top: 20px;">
                      <form id="requestcallLogEntryForm" style="margin-left: 10px">
                        ...
                        <input type="hidden" name="not_registered_patient_week1" id="not_registered_patient_week1"
                          value="not_registered_patient_week1">
                        <div class="row">
                          <div class="col-md-3">

                            <label for="criteria_id"><?php echo _l('patient_response'); ?></label>
                            <select class="selectpicker form-control criteria_id" data-width="100%" name="criteria_id"
                        ...
                        <div class="col-md-12 text-right mt-3">
                          <button type="submit" class="btn btn-success"
                            style="margin-top: 25px;"><?= _l('Save'); ?></button>
                        </div>
                      </form>
                    </div>

                    <div id="invoice-details-section" style="display: none; margin-top: 20px;"
                      ...
                      <form id="estimationForm" style="margin-left: 10px">
                        <input type="hidden" name="patient_treatment_id" id="patient_treatment_id"
                          value="<?= $latest_casesheet_package->patient_treatment_id; ?>">
                        <div class="row">
                          <div class="col-md-4 form-group">
                            <label><?php echo _l('treatment_name'); ?></label>
                            <input type="text" name="invoice_treatment_name" class="form-control"
                              value="<?php echo $latest_casesheet_package->treatment_name; ?>" readonly>
                          </div>
                          <div class="col-md-4 form-group">
                            <label><?php echo _l('dr_suggested_duration'); ?></label>
                            <input type="text" name="dr_duration" class="form-control"
                              value="<?php echo $latest_casesheet_package->duration_value; ?> Months" readonly>
                          </div>
                        ...
                        <div class="mt-2" id="periodWarning" style="display: none;">
                          <div class="col-md-12 form-group">
                            <label><?php echo _l('remarks'); ?></label>
                            <div id="durationWarning" class="alert alert-warning"
                              style="font-weight: 500; display: none;">
                              ⚠️ Why are you creating a <span id="selectedMonths"></span> package by invoice period when
                              Dr.<?php echo $latest_casesheet_package->firstname . ' ' . $latest_casesheet_package->lastname; ?>
                              suggested for <strong><?= $selected_duration ?> months</strong>?
                            </div>
                        ...
                        <input type="hidden" name="number" class="form-control"
                          value="<?php echo e($_estimate_number); ?>" data-isedit="<?php echo e($isedit); ?>"
                        ...
                        <input type="hidden" name="sale_agent" class="form-control"
    ...
    <input type="date" name="expirydate" class="form-control" value="<?= $expiry_date; ?>" style="width: 100%">
                        ...
                        <input type="hidden" name="newitems[1][description]" id="itemDescription" class="form-control"
                          readonly>
                        <input type="hidden" name="newitems[1][qty]" id="itemQty" class="form-control" value="1">

                        <input type="hidden" step="0.01" name="newitems[1][rate]" id="itemRate" class="form-control"
                          readonly>
                        ...
                        <div class="row mt-3">
                          ...
                          <div class="col-md-4 form-group">
                            ...
                            <select name="item_select" class="form-control selectpicker" data-live-search="true"
                              id="itemSelect" required>
                              <option value=""></option>
                              <option value="<?= e($matched_package_item['id']); ?>">
                                <?= e($matched_package_item['description']); ?>
                                (<?= e(app_format_number($matched_package_item['rate'])); ?>)
                              </option>
                            </select>
                          </div>
                          <?php endif; ?>
                        ...
                        */
                          ...
                          <div class="col-md-4 form-group">
                            ...
                            <div class="input-group" id="discount-wrapper">
                              ...
                              <input type="number" class="form-control input-discount-percent" name="discount_percent"
                                min="0" max="<?php echo $max_discount; ?>" value="0" readonly>


                              <!-- Fixed Input -->
                              <input type="hidden" class="form-control input-discount-fixed d-none"
                                name="discount_total">
                              ...
                              <div class="input-group-addon">
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" id="discount-total-type-dropdown"
                                    ...
                                    <li><a href="#" class="discount-total-type discount-type-percent selected">%</a>
                                    </li>
                                    <!--<li><a href="#" class="discount-total-type discount-type-fixed">₹ Fixed Amount</a></li>-->
                                  </ul>
                                </div>
      ...
      <label>Subtotal</label>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <select class="form-control selectpicker" name="appointment_type_id"
                                id="appointment_type_id" data-live-search="true" required>
                                <option value=""></option>
                                <?php foreach ($appointment_type as $app): ?>
                                <option value="<?= $app['appointment_type_id']; ?>">
                                  <?= $app['appointment_type_name']; ?></option>
                                <?php endforeach; ?>
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4 form-group">
                            ...
                            <select class="selectpicker form-control" name="paymentmode" data-width="100%"
                              data-none-selected-text="<?= _l('dropdown_non_selected_tex'); ?>" <?= ($invoice_acknowledge != 'before_payment') ? 'required' : ''; ?>>
                          ...
                          <div class="col-md-4 form-group">
                            ...
                            <button type="submit" class="btn btn-success"
                              style="margin-top: 6px"><?php echo _l('save_and_pay'); ?></button>
                          </div>
                        </div>
                ...
                <div class="table-responsive">
                  ...
                  <div id="invoicePaymentFormSection" style="display: none;">
                    <div class="text-end mb-3">
                      <button type="button" class="btn btn-secondary" id="btnBackToTable">←
                    ...
                    <div class="row">
                      <div class="form-group col-md-4" app-field-wrapper="amount">
                        ...
                        <input type="number" id="invoice_payment_amount" name="amount" class="form-control" min="1"
                          step="0.01" required>
        ...
        <?= render_date_input('date', 'Payment Date', _d(date('Y-m-d'))); ?>
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <select class="selectpicker" name="paymentmode" id="paymentmode" data-width="100%"
        ...
        <?= render_input('transactionid', 'Transaction ID'); ?>
                      ...
                      <div class="form-group">
                        <button type="submit" class="btn btn-success"
                          style="margin-top: 26px"><?php echo _l('submit_payment'); ?> </button>
                      </div>
                    </div>
              ...
              <div role="tabpanel" class="tab-pane" id="tab_feedback" style="min-height: 300px;">
                ...
                <button class="btn btn-primary btn-sm" onclick="toggleFeedbackForm()"
                  style="float: right; margin-top: 6px; margin-right: 5px;"><?php echo _l('send_request'); ?>
                </button>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-check form-check-inline">
                          ...
                          <input class="form-check-input" type="radio" name="send_whatsapp" value="0" id="whatsappNo"
                            checked>
              ...
              <div role="tabpanel" class="tab-pane" id="tab_calls">
                <div class="table-responsive">
                  ...
                  <button class="btn btn-primary btn-sm" onclick="toggleCallLogForm()"
                    style="float: right; margin-top: 6px; margin-right: 5px;"><?php echo _l('add_call'); ?>
                  </button>
                  <?php
                  }
                  ?>
                    ...
                    <form id="callLogEntryForm">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <select class="form-control criteria_id_val" name="criteria_id"
                            style="padding:6px 8px; line-height:1.5;" id="criteria_id" required>
                            ...
                            foreach ($select_options as $option) {
                              ...
                              ?>
                            <option value="<?= $option['id'] ?>" <?= (isset($selected_criteria) && $selected_criteria == $option['id']) ? 'selected' : '' ?>>
                              <?= $option['name'] ?>
                            </option>
                            <?php
                              //}
                        ...
                        <div id="medicine-calling-fields" class="row" style="display:none; margin-top:10px;">
                          <div class="col-md-3">
                            ...
                            <input type="number" name="pharmacy_medicine_days" id="pharmacy_medicine_days"
                              class="form-control">
                          </div>
                          <div class="col-md-3">
                            <label>Patient Took Medicine Days <span style="color:red;">*</span></label>
                            <input type="number" name="patient_took_medicine_days" id="patient_took_medicine_days"
                              class="form-control">
                          </div>
                        </div>
                        ...
                        <div class="col-md-3">
                          ...
                          <select class="form-control patient_response_id" name="patient_response_id" style="padding: 0"
                            id="patient_response_id_1" required>
                        ...
                        <div class="col-md-3">
                          ...
                          ?>
                          <input type="datetime-local" name="next_calling_date" id="next_calling_date"
                            class="form-control" min="<?php echo $now; ?>">
                        </div>
                          ...
                          <div class="row" style="padding: 10px;">
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <select class="form-control selectpicker" name="doctor_id" id="doctor_id_1"
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                <label class="form-label"><span style="color: #f00">*</span>
                                  <?= _l('appointment_date') ?></label>
                                <?php
                                $now = date('Y-m-d\TH:i'); // Correct format for datetime-local input
                                ?>
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <select class="form-control selectpicker" name="appointment_type_id"
                                  id="appointment_type_id" data-live-search="true">
                                  <option value=""></option>
                                  <?php foreach ($appointment_type as $app): ?>
                                  <option value="<?= $app['appointment_type_id']; ?>">
                                    <?= $app['appointment_type_name']; ?></option>
                                ...
                                <select name="item_select" class="form-control selectpicker" data-live-search="true"
                                  ...
                                  <optgroup data-group-id="<?= e($group_id); ?>" label="<?= $group_name; ?>">
                                    <?php foreach ($_items as $item) {
                                      ...
                                      ?>
                                    <option value="<?= e($item['rate']); ?>" data-rate="<?= e($item['rate']); ?>"
                            ...
                            <div class="appointment_payment_section">
                              ...
                              <div class="col-md-3">
                                <div class="form-group">
                                  ...
                                  <span id="payment_amount_required_indicator"
                                    style="color:red; display: none;">*</span>
                                  <label><?= _l('payment_amount'); ?></label>
                                  <input type="number" class="form-control" id="paying_amount_1" name="payment_amount"
                                    min="0" step="0.01" placeholder="<?= _l('enter_payment_amount'); ?>">
                        ...
                        <div class="col-md-6">
                          ...
                          <textarea name="comments" class="form-control" rows="2"
                            placeholder="<?= _l('enter_comments'); ?>"></textarea>
                        </div>

                        <div class="col-md-3">
                          <label>&nbsp;<br></label>
                          <button type="submit" class="btn btn-success"
                            style="margin-top: 25px;"><?= _l('submit'); ?></button>
                        </div>
                      </div>
...
/* $(function() {
    initDataTable('.table-message-log-table', admin_url + 'client/message_log_table/' + <?= $client->userid ?>, undefined, undefined, '', [0, 'desc']);
            ...
            <div class="modal fade child-modal" id="caseSheetModal" tabindex="-1" role="dialog"
              aria-labelledby="caseSheetModalLabel" style="margin-top: 35px;" aria-hidden="true">
