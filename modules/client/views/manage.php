                ...
                <div class="tw-mb-6">
                    ...
                    <div class="tw-grid tw-grid-cols-2 md:tw-grid-cols-3 lg:tw-grid-cols-6 tw-gap-2">
                        ...
                        <div
                            class="tw-border-neutral-300/80 tw-shadow-sm tw-text-sm tw-border tw-border-solid tw-rounded-lg tw-px-4 tw-py-3 text-sm tw-flex-1 tw-flex tw-items-center tw-font-medium tw-bg-white">
                            <span class="tw-font-semibold tw-mr-1 rtl:tw-ml-1">
                                <?= total_rows(db_prefix() . 'appointment', ['DATE(appointment_date)' => date('Y-m-d')]); ?></span>
                            <span
                                class="text-success tw-truncate sm:tw-text-clip"><?= _l('appointments'); ?></span>
                        </div>
                        <div
                            class="tw-border-neutral-300/80 tw-shadow-sm tw-text-sm tw-border tw-border-solid tw-rounded-lg tw-px-4 tw-py-3 text-sm tw-flex-1 tw-flex tw-items-center tw-font-medium tw-bg-white">
                            <span class="tw-font-semibold tw-mr-1 rtl:tw-ml-1">
                                <?= total_rows(db_prefix() . 'appointment', [
									'visit_status' => 0,
									'appointment_date <' => date('Y-m-d')
								]); ?>
								</span>
                            <span
                                class="text-danger tw-truncate sm:tw-text-clip"><?= _l('missed'); ?></span>
                        </div>
						<div
                            class="tw-border-neutral-300/80 tw-shadow-sm tw-text-sm tw-border tw-border-solid tw-rounded-lg tw-px-4 tw-py-3 text-sm tw-flex-1 tw-flex tw-items-center tw-font-medium tw-bg-white">
                            <span class="tw-font-semibold tw-mr-1 rtl:tw-ml-1">
                            ...
                            <span
                                class="text-success tw-truncate sm:tw-text-clip"><?= _l('consulted'); ?></span>
                        </div>
                        <!--<div
                            class="tw-border-neutral-300/80 tw-shadow-sm tw-text-sm tw-border tw-border-solid tw-rounded-lg tw-px-4 tw-py-3 text-sm tw-flex-1 tw-flex tw-items-center tw-font-medium tw-bg-white">
                            <span class="tw-font-semibold tw-mr-1 rtl:tw-ml-1">
