        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <?php }
                    if (staff_can('view_appointments', 'customers') || staff_can('view_global_appointments', 'customers')) { ?>
                        <li role="presentation"
                            class="<?php if (staff_cant('view', 'customers') && staff_cant('view_own', 'customers')) { ?>active<?php } ?>">
                ...
                <div class="tab-content">
                    <!-- Tab 1: Patients -->
                    <div role="tabpanel"
                        class="tab-pane <?php if (staff_can('view', 'customers') || staff_can('view_own', 'customers')) { ?>active <?php } ?>"
                        id="patients-tab" style="margin-top: -40px">
                        <br>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <ul class="nav nav-tabs" role="tablist">
                                                                <?php if (staff_can('view', 'customers') || staff_can('view_own', 'customers')) { ?>
                                                                    <li role="presentation" class="active">
                                                                        <a href="#patients-tab" aria-controls="patients-tab"
                                                                ...
                                                                if (staff_can('view_appointments', 'customers') || staff_can('view_global_appointments', 'customers')) { ?>
                                                                    <li role="presentation"
                                                                        class="<?php if (staff_cant('view', 'customers') && staff_cant('view_own', 'customers')) { ?>active<?php } ?>">
                                                                        <a href="#appointments-tab"
                                                                            aria-controls="appointments-tab" role="tab"
                                                                            data-toggle="tab">
                                                                            <?= _l('appointments'); ?>
                                                                        </a>
                                                                    </li>
                                                            ...
                                                            <div class="tab-content">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            <div class="row">
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        class="col-md-6 text-right d-flex justify-content-end gap-2">
                                                                                        <?php if (staff_can('create', 'customers')) { ?>
                                                                                            <a href="<?= admin_url('client/client/add_client'); ?>"
                                                                                                class="btn btn-primary">
                                                                                                <i
                                                                                                    class="fa-regular fa-plus tw-mr-1"></i>
                                                                                                <?= _l('new_client'); ?>
                                                                                            </a>
                                                                                        <?php } ?>
                                                                                    </div>
                                                                ...
                                                                <!-- Tab 2: Appointments -->
                                                                <div role="tabpanel"
                                                                    class="tab-pane <?php if (staff_can('view_appointments', 'customers') AND (staff_cant('view', 'customers') && staff_cant('view_own', 'customers'))) { ?>active <?php } ?>"
                                                                    id="appointments-tab" style="margin-top: -40px">
                                                                    <br>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div id="appointment_table_div">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-4">
                                                                                        <label
                                                                                            for="appointment_status"><?= _l('status'); ?></label>
                                                                                        <select
                                                                                            class="form-control appointment_status"
