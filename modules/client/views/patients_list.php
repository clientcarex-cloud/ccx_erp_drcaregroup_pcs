                            ...
                            <div class="panel-body">
                                              ...
                                              if (staff_can('view_appointments_calendar', 'customers')) {
                                                  ?>
                                                    ...
                                                    <a href="<?= admin_url('client/doctor_calendar_view') ?>"
                                                        title="Switch to Appointments" class="btn btn-sm btn-primary">
                                ...
                                <div id="appointment_table_div">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label><?= _l('from_date'); ?></label>
                                            <input type="date" class="form-control" name="consulted_date"
                                                id="consulted_date" value="<?= date('Y-m-d'); ?>">
                                        </div>
                                        <div class="col-md-3">
                                            <label><?= _l('to_date'); ?></label>
                                ...
                                <div id="paymentFormContainer" style="display: none;">
                                    ...
                                    <div class="row" style="width: 99%">
                                        ...
                                        <div class="form-group col-md-3">
                                            <button type="submit" class="btn btn-success" name="submit_action"
                                                value="pay" style="margin-top: 24px"><?= _l('pay'); ?></button>
                                            <button type="submit" class="btn btn-success" name="submit_action"
                                                value="pay_print"
