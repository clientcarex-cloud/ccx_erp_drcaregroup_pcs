...
if (!$CI->db->field_exists('bank_ifsc_code', $tbl)) {
    $CI->db->query("ALTER TABLE `$tbl`
        ADD COLUMN `bank_ifsc_code` VARCHAR(25) DEFAULT NULL;");
}
if (!$CI->db->field_exists('title', $tbl)) {
    $CI->db->query("ALTER TABLE `$tbl`
        ADD COLUMN `title` VARCHAR(20) DEFAULT NULL,
        ...
        ADD COLUMN `father_phone` VARCHAR(20) DEFAULT NULL,
        ADD COLUMN `mother_name` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `mother_occupation` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `mother_phone` VARCHAR(20) DEFAULT NULL,
        ADD COLUMN `responsible_person_name` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `responsible_person_occupation` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `responsible_person_phone` VARCHAR(20) DEFAULT NULL,
        ADD COLUMN `emergency_contact_person` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `relation_with_employee` VARCHAR(50) DEFAULT NULL,
        ADD COLUMN `emergency_contact_number` VARCHAR(20) DEFAULT NULL,
        ADD COLUMN `alternate_mobile` VARCHAR(20) DEFAULT NULL,
        ADD COLUMN `whatsapp_number` VARCHAR(20) DEFAULT NULL,
        ADD COLUMN `present_address` VARCHAR(255) DEFAULT NULL,
        ADD COLUMN `present_city` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `present_state` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `present_pincode` VARCHAR(20) DEFAULT NULL,
        ADD COLUMN `permanent_address` VARCHAR(255) DEFAULT NULL,
        ADD COLUMN `permanent_city` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `permanent_state` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `permanent_country` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `permanent_pincode` VARCHAR(20) DEFAULT NULL,
        ADD COLUMN `joining_date` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `pan_number` VARCHAR(20) DEFAULT NULL,
        ADD COLUMN `aadhaar_number` VARCHAR(20) DEFAULT NULL,
        ADD COLUMN `job_type` VARCHAR(50) DEFAULT NULL,
        ADD COLUMN `bhms_reg_number` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `bhms_expiry_date` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `bond_from_date` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `bond_end_date` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `cheque_number` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `cheque_amount` DECIMAL(10,2) DEFAULT NULL,
        ADD COLUMN `cheque_bank` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `cheque_received_date` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `bhms_certificate_file` VARCHAR(255) DEFAULT NULL,
        ADD COLUMN `bond_file` VARCHAR(255) DEFAULT NULL,
        ADD COLUMN `cheque_scanned_file` VARCHAR(255) DEFAULT NULL,
        ADD COLUMN `timing_effective_date` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `eligible_ots` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `ots_effective_date` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `fixed_week_off` VARCHAR(50) DEFAULT NULL,
        ADD COLUMN `week_off_on` VARCHAR(50) DEFAULT NULL,
        ADD COLUMN `week_off_sat_sun` TINYINT(1) DEFAULT 0,
        ADD COLUMN `week_off_effective_from` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `pf_deduct` TINYINT(1) DEFAULT 0,
        ADD COLUMN `pf_number` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `pf_uan` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `pt_deduct` TINYINT(1) DEFAULT 0,
        ADD COLUMN `esi_deduct` TINYINT(1) DEFAULT 0,
        ADD COLUMN `esi_number` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `bank_name` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `salary_amount` DECIMAL(15,2) DEFAULT NULL,
        ADD COLUMN `allowance` DECIMAL(15,2) DEFAULT NULL,
        ADD COLUMN `salary_effective_date` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `next_hike_date` VARCHAR(100) DEFAULT NULL,
        ADD COLUMN `salary_description` TEXT DEFAULT NULL,
        ADD COLUMN `employeeId` VARCHAR(50) DEFAULT NULL;
    ");
}
