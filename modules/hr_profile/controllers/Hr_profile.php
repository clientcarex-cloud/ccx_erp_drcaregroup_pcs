				...
				if (!empty($tmpFilePath) && $tmpFilePath != '') {
					...
					if (move_uploaded_file($tmpFilePath, $newFilePath)) {
						...
						$writer_header = array(
							...
							_l('title') => 'string',
							_l('blood_group') => 'string',
							_l('father_name') => 'string',
							_l('father_occupation') => 'string',
							_l('father_phone') => 'string',
							_l('mother_name') => 'string',
							_l('mother_occupation') => 'string',
							_l('mother_phone') => 'string',
							_l('responsible_person_name') => 'string',
							_l('responsible_person_occupation') => 'string',
							_l('responsible_person_phone') => 'string',
							_l('emergency_contact_person') => 'string',
							_l('relation_with_employee') => 'string',
							_l('emergency_contact_number') => 'string',
							_l('alternate_mobile') => 'string',
							_l('whatsapp_number') => 'string',
							_l('present_address') => 'string',
							_l('present_city') => 'string',
							_l('present_state') => 'string',
							_l('present_pincode') => 'string',
							_l('permanent_address') => 'string',
							_l('permanent_city') => 'string',
							_l('permanent_state') => 'string',
							_l('permanent_country') => 'string',
							_l('permanent_pincode') => 'string',
							_l('joining_date') => 'string',
							_l('pan_number') => 'string',
							_l('aadhaar_number') => 'string',
							_l('job_type') => 'string',
							_l('bhms_reg_number') => 'string',
							_l('bhms_expiry_date') => 'string',
							_l('bond_from_date') => 'string',
							_l('bond_end_date') => 'string',
							_l('cheque_number') => 'string',
							_l('cheque_amount') => 'string',
							_l('cheque_bank') => 'string',
							_l('cheque_received_date') => 'string',
							_l('bhms_certificate_file') => 'string',
							_l('bond_file') => 'string',
							_l('cheque_scanned_file') => 'string',
							_l('timing_effective_date') => 'string',
							_l('eligible_ots') => 'string',
							_l('ots_effective_date') => 'string',
							_l('fixed_week_off') => 'string',
							_l('week_off_on') => 'string',
							_l('week_off_sat_sun') => 'string',
							_l('week_off_effective_from') => 'string',
							_l('pf_deduct') => 'string',
							_l('pf_number') => 'string',
							_l('pf_uan') => 'string',
							_l('pt_deduct') => 'string',
							_l('esi_deduct') => 'string',
							_l('esi_number') => 'string',
							_l('bank_name') => 'string',
							_l('salary_amount') => 'string',
							_l('allowance') => 'string',
							_l('salary_effective_date') => 'string',
							_l('next_hike_date') => 'string',
							_l('salary_description') => 'string',
							_l('employeeId') => 'string',
						...
						$widths = [40, 40, 40, 50, 40, 40, 40, 40, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50];
						...
						$arr_header['skype'] = 33;
						$arr_header['title'] = 34;
						$arr_header['blood_group'] = 35;
						$arr_header['father_name'] = 36;
						$arr_header['father_occupation'] = 37;
						$arr_header['father_phone'] = 38;
						$arr_header['mother_name'] = 39;
						$arr_header['mother_occupation'] = 40;
						$arr_header['mother_phone'] = 41;
						$arr_header['responsible_person_name'] = 42;
						$arr_header['responsible_person_occupation'] = 43;
						$arr_header['responsible_person_phone'] = 44;
						$arr_header['emergency_contact_person'] = 45;
						$arr_header['relation_with_employee'] = 46;
						$arr_header['emergency_contact_number'] = 47;
						$arr_header['alternate_mobile'] = 48;
						$arr_header['whatsapp_number'] = 49;
						$arr_header['present_address'] = 50;
						$arr_header['present_city'] = 51;
						$arr_header['present_state'] = 52;
						$arr_header['present_pincode'] = 53;
						$arr_header['permanent_address'] = 54;
						$arr_header['permanent_city'] = 55;
						$arr_header['permanent_state'] = 56;
						$arr_header['permanent_country'] = 57;
						$arr_header['permanent_pincode'] = 58;
						$arr_header['joining_date'] = 59;
						$arr_header['pan_number'] = 60;
						$arr_header['aadhaar_number'] = 61;
						$arr_header['job_type'] = 62;
						$arr_header['bhms_reg_number'] = 63;
						$arr_header['bhms_expiry_date'] = 64;
						$arr_header['bond_from_date'] = 65;
						$arr_header['bond_end_date'] = 66;
						$arr_header['cheque_number'] = 67;
						$arr_header['cheque_amount'] = 68;
						$arr_header['cheque_bank'] = 69;
						$arr_header['cheque_received_date'] = 70;
						$arr_header['bhms_certificate_file'] = 71;
						$arr_header['bond_file'] = 72;
						$arr_header['cheque_scanned_file'] = 73;
						$arr_header['timing_effective_date'] = 74;
						$arr_header['eligible_ots'] = 75;
						$arr_header['ots_effective_date'] = 76;
						$arr_header['fixed_week_off'] = 77;
						$arr_header['week_off_on'] = 78;
						$arr_header['week_off_sat_sun'] = 79;
						$arr_header['week_off_effective_from'] = 80;
						$arr_header['pf_deduct'] = 81;
						$arr_header['pf_number'] = 82;
						$arr_header['pf_uan'] = 83;
						$arr_header['pt_deduct'] = 84;
						$arr_header['esi_deduct'] = 85;
						$arr_header['esi_number'] = 86;
						$arr_header['bank_name'] = 87;
						$arr_header['salary_amount'] = 88;
						$arr_header['allowance'] = 89;
						$arr_header['salary_effective_date'] = 90;
						$arr_header['next_hike_date'] = 91;
						$arr_header['salary_description'] = 92;
						$arr_header['employeeId'] = 93;
						...
						for ($row = 2; $row < count($data); $row++) {
							...
							$value_title = isset($data[$row][$arr_header['title']]) ? $data[$row][$arr_header['title']] : '';
							$value_blood_group = isset($data[$row][$arr_header['blood_group']]) ? $data[$row][$arr_header['blood_group']] : '';
							$value_father_name = isset($data[$row][$arr_header['father_name']]) ? $data[$row][$arr_header['father_name']] : '';
							$value_father_occupation = isset($data[$row][$arr_header['father_occupation']]) ? $data[$row][$arr_header['father_occupation']] : '';
							$value_father_phone = isset($data[$row][$arr_header['father_phone']]) ? $data[$row][$arr_header['father_phone']] : '';
							$value_mother_name = isset($data[$row][$arr_header['mother_name']]) ? $data[$row][$arr_header['mother_name']] : '';
							$value_mother_occupation = isset($data[$row][$arr_header['mother_occupation']]) ? $data[$row][$arr_header['mother_occupation']] : '';
							$value_mother_phone = isset($data[$row][$arr_header['mother_phone']]) ? $data[$row][$arr_header['mother_phone']] : '';
							$value_responsible_person_name = isset($data[$row][$arr_header['responsible_person_name']]) ? $data[$row][$arr_header['responsible_person_name']] : '';
							$value_responsible_person_occupation = isset($data[$row][$arr_header['responsible_person_occupation']]) ? $data[$row][$arr_header['responsible_person_occupation']] : '';
							$value_responsible_person_phone = isset($data[$row][$arr_header['responsible_person_phone']]) ? $data[$row][$arr_header['responsible_person_phone']] : '';
							$value_emergency_contact_person = isset($data[$row][$arr_header['emergency_contact_person']]) ? $data[$row][$arr_header['emergency_contact_person']] : '';
							$value_relation_with_employee = isset($data[$row][$arr_header['relation_with_employee']]) ? $data[$row][$arr_header['relation_with_employee']] : '';
							$value_emergency_contact_number = isset($data[$row][$arr_header['emergency_contact_number']]) ? $data[$row][$arr_header['emergency_contact_number']] : '';
							$value_alternate_mobile = isset($data[$row][$arr_header['alternate_mobile']]) ? $data[$row][$arr_header['alternate_mobile']] : '';
							$value_whatsapp_number = isset($data[$row][$arr_header['whatsapp_number']]) ? $data[$row][$arr_header['whatsapp_number']] : '';
							$value_present_address = isset($data[$row][$arr_header['present_address']]) ? $data[$row][$arr_header['present_address']] : '';
							$value_present_city = isset($data[$row][$arr_header['present_city']]) ? $data[$row][$arr_header['present_city']] : '';
							$value_present_state = isset($data[$row][$arr_header['present_state']]) ? $data[$row][$arr_header['present_state']] : '';
							$value_present_pincode = isset($data[$row][$arr_header['present_pincode']]) ? $data[$row][$arr_header['present_pincode']] : '';
							$value_permanent_address = isset($data[$row][$arr_header['permanent_address']]) ? $data[$row][$arr_header['permanent_address']] : '';
							$value_permanent_city = isset($data[$row][$arr_header['permanent_city']]) ? $data[$row][$arr_header['permanent_city']] : '';
							$value_permanent_state = isset($data[$row][$arr_header['permanent_state']]) ? $data[$row][$arr_header['permanent_state']] : '';
							$value_permanent_country = isset($data[$row][$arr_header['permanent_country']]) ? $data[$row][$arr_header['permanent_country']] : '';
							$value_permanent_pincode = isset($data[$row][$arr_header['permanent_pincode']]) ? $data[$row][$arr_header['permanent_pincode']] : '';
							$value_joining_date = isset($data[$row][$arr_header['joining_date']]) ? $data[$row][$arr_header['joining_date']] : '';
							$value_pan_number = isset($data[$row][$arr_header['pan_number']]) ? $data[$row][$arr_header['pan_number']] : '';
							$value_aadhaar_number = isset($data[$row][$arr_header['aadhaar_number']]) ? $data[$row][$arr_header['aadhaar_number']] : '';
							$value_job_type = isset($data[$row][$arr_header['job_type']]) ? $data[$row][$arr_header['job_type']] : '';
							$value_bhms_reg_number = isset($data[$row][$arr_header['bhms_reg_number']]) ? $data[$row][$arr_header['bhms_reg_number']] : '';
							$value_bhms_expiry_date = isset($data[$row][$arr_header['bhms_expiry_date']]) ? $data[$row][$arr_header['bhms_expiry_date']] : '';
							$value_bond_from_date = isset($data[$row][$arr_header['bond_from_date']]) ? $data[$row][$arr_header['bond_from_date']] : '';
							$value_bond_end_date = isset($data[$row][$arr_header['bond_end_date']]) ? $data[$row][$arr_header['bond_end_date']] : '';
							$value_cheque_number = isset($data[$row][$arr_header['cheque_number']]) ? $data[$row][$arr_header['cheque_number']] : '';
							$value_cheque_amount = isset($data[$row][$arr_header['cheque_amount']]) ? $data[$row][$arr_header['cheque_amount']] : '';
							$value_cheque_bank = isset($data[$row][$arr_header['cheque_bank']]) ? $data[$row][$arr_header['cheque_bank']] : '';
							$value_cheque_received_date = isset($data[$row][$arr_header['cheque_received_date']]) ? $data[$row][$arr_header['cheque_received_date']] : '';
							$value_bhms_certificate_file = isset($data[$row][$arr_header['bhms_certificate_file']]) ? $data[$row][$arr_header['bhms_certificate_file']] : '';
							$value_bond_file = isset($data[$row][$arr_header['bond_file']]) ? $data[$row][$arr_header['bond_file']] : '';
							$value_cheque_scanned_file = isset($data[$row][$arr_header['cheque_scanned_file']]) ? $data[$row][$arr_header['cheque_scanned_file']] : '';
							$value_timing_effective_date = isset($data[$row][$arr_header['timing_effective_date']]) ? $data[$row][$arr_header['timing_effective_date']] : '';
							$value_eligible_ots = isset($data[$row][$arr_header['eligible_ots']]) ? $data[$row][$arr_header['eligible_ots']] : '';
							$value_ots_effective_date = isset($data[$row][$arr_header['ots_effective_date']]) ? $data[$row][$arr_header['ots_effective_date']] : '';
							$value_fixed_week_off = isset($data[$row][$arr_header['fixed_week_off']]) ? $data[$row][$arr_header['fixed_week_off']] : '';
							$value_week_off_on = isset($data[$row][$arr_header['week_off_on']]) ? $data[$row][$arr_header['week_off_on']] : '';
							$value_week_off_sat_sun = isset($data[$row][$arr_header['week_off_sat_sun']]) ? $data[$row][$arr_header['week_off_sat_sun']] : '';
							$value_week_off_effective_from = isset($data[$row][$arr_header['week_off_effective_from']]) ? $data[$row][$arr_header['week_off_effective_from']] : '';
							$value_pf_deduct = isset($data[$row][$arr_header['pf_deduct']]) ? $data[$row][$arr_header['pf_deduct']] : '';
							$value_pf_number = isset($data[$row][$arr_header['pf_number']]) ? $data[$row][$arr_header['pf_number']] : '';
							$value_pf_uan = isset($data[$row][$arr_header['pf_uan']]) ? $data[$row][$arr_header['pf_uan']] : '';
							$value_pt_deduct = isset($data[$row][$arr_header['pt_deduct']]) ? $data[$row][$arr_header['pt_deduct']] : '';
							$value_esi_deduct = isset($data[$row][$arr_header['esi_deduct']]) ? $data[$row][$arr_header['esi_deduct']] : '';
							$value_esi_number = isset($data[$row][$arr_header['esi_number']]) ? $data[$row][$arr_header['esi_number']] : '';
							$value_bank_name = isset($data[$row][$arr_header['bank_name']]) ? $data[$row][$arr_header['bank_name']] : '';
							$value_salary_amount = isset($data[$row][$arr_header['salary_amount']]) ? $data[$row][$arr_header['salary_amount']] : '';
							$value_allowance = isset($data[$row][$arr_header['allowance']]) ? $data[$row][$arr_header['allowance']] : '';
							$value_salary_effective_date = isset($data[$row][$arr_header['salary_effective_date']]) ? $data[$row][$arr_header['salary_effective_date']] : '';
							$value_next_hike_date = isset($data[$row][$arr_header['next_hike_date']]) ? $data[$row][$arr_header['next_hike_date']] : '';
							$value_salary_description = isset($data[$row][$arr_header['salary_description']]) ? $data[$row][$arr_header['salary_description']] : '';
							$value_employeeId = isset($data[$row][$arr_header['employeeId']]) ? $data[$row][$arr_header['employeeId']] : '';
							...
							if (($flag == 1) || $flag2 == 1) {
								...
								$writer->writeSheetRow('Sheet1', [
									...
									$value_blood_group,
									$value_father_name,
									$value_father_occupation,
									$value_father_phone,
									$value_mother_name,
									$value_mother_occupation,
									$value_mother_phone,
									$value_responsible_person_name,
									$value_responsible_person_occupation,
									$value_responsible_person_phone,
									$value_emergency_contact_person,
									$value_relation_with_employee,
									$value_emergency_contact_number,
									$value_alternate_mobile,
									$value_whatsapp_number,
									$value_present_address,
									$value_present_city,
									$value_present_state,
									$value_present_pincode,
									$value_permanent_address,
									$value_permanent_city,
									$value_permanent_state,
									$value_permanent_country,
									$value_permanent_pincode,
									$value_joining_date,
									$value_pan_number,
									$value_aadhaar_number,
									$value_job_type,
									$value_bhms_reg_number,
									$value_bhms_expiry_date,
									$value_bond_from_date,
									$value_bond_end_date,
									$value_cheque_number,
									$value_cheque_amount,
									$value_cheque_bank,
									$value_cheque_received_date,
									$value_bhms_certificate_file,
									$value_bond_file,
									$value_cheque_scanned_file,
									$value_timing_effective_date,
									$value_eligible_ots,
									$value_ots_effective_date,
									$value_fixed_week_off,
									$value_week_off_on,
									$value_week_off_sat_sun,
									$value_week_off_effective_from,
									$value_pf_deduct,
									$value_pf_number,
									$value_pf_uan,
									$value_pt_deduct,
									...
									$value_salary_amount,
									$value_allowance,
									$value_salary_effective_date,
									$value_next_hike_date,
									$value_salary_description,
									$value_employeeId,
							...
							if ($flag == 0 && $flag2 == 0) {
								...
								$rd['title'] = $value_title;
								$rd['blood_group'] = $value_blood_group;
								$rd['father_name'] = $value_father_name;
								$rd['father_occupation'] = $value_father_occupation;
								$rd['father_phone'] = $value_father_phone;
								$rd['mother_name'] = $value_mother_name;
								$rd['mother_occupation'] = $value_mother_occupation;
								$rd['mother_phone'] = $value_mother_phone;
								$rd['responsible_person_name'] = $value_responsible_person_name;
								$rd['responsible_person_occupation'] = $value_responsible_person_occupation;
								$rd['responsible_person_phone'] = $value_responsible_person_phone;
								$rd['emergency_contact_person'] = $value_emergency_contact_person;
								$rd['relation_with_employee'] = $value_relation_with_employee;
								$rd['emergency_contact_number'] = $value_emergency_contact_number;
								$rd['alternate_mobile'] = $value_alternate_mobile;
								$rd['whatsapp_number'] = $value_whatsapp_number;
								$rd['present_address'] = $value_present_address;
								$rd['present_city'] = $value_present_city;
								$rd['present_state'] = $value_present_state;
								$rd['present_pincode'] = $value_present_pincode;
								$rd['permanent_address'] = $value_permanent_address;
								$rd['permanent_city'] = $value_permanent_city;
								$rd['permanent_state'] = $value_permanent_state;
								$rd['permanent_country'] = $value_permanent_country;
								$rd['permanent_pincode'] = $value_permanent_pincode;
								$rd['joining_date'] = $value_joining_date;
								$rd['pan_number'] = $value_pan_number;
								$rd['aadhaar_number'] = $value_aadhaar_number;
								$rd['job_type'] = $value_job_type;
								$rd['bhms_reg_number'] = $value_bhms_reg_number;
								$rd['bhms_expiry_date'] = $value_bhms_expiry_date;
								$rd['bond_from_date'] = $value_bond_from_date;
								$rd['bond_end_date'] = $value_bond_end_date;
								$rd['cheque_number'] = $value_cheque_number;
								$rd['cheque_amount'] = $value_cheque_amount;
								$rd['cheque_bank'] = $value_cheque_bank;
								$rd['cheque_received_date'] = $value_cheque_received_date;
								$rd['bhms_certificate_file'] = $value_bhms_certificate_file;
								$rd['bond_file'] = $value_bond_file;
								$rd['cheque_scanned_file'] = $value_cheque_scanned_file;
								$rd['timing_effective_date'] = $value_timing_effective_date;
								$rd['eligible_ots'] = $value_eligible_ots;
								$rd['ots_effective_date'] = $value_ots_effective_date;
								$rd['fixed_week_off'] = $value_fixed_week_off;
								$rd['week_off_on'] = $value_week_off_on;
								$rd['week_off_sat_sun'] = $value_week_off_sat_sun;
								$rd['week_off_effective_from'] = $value_week_off_effective_from;
								$rd['pf_deduct'] = $value_pf_deduct;
								$rd['pf_number'] = $value_pf_number;
								$rd['pf_uan'] = $value_pf_uan;
								$rd['pt_deduct'] = $value_pt_deduct;
								$rd['esi_deduct'] = $value_esi_deduct;
								$rd['esi_number'] = $value_esi_number;
								$rd['bank_name'] = $value_bank_name;
								$rd['salary_amount'] = $value_salary_amount;
								$rd['allowance'] = $value_allowance;
								$rd['salary_effective_date'] = $value_salary_effective_date;
								$rd['next_hike_date'] = $value_next_hike_date;
								$rd['salary_description'] = $value_salary_description;
								$rd['employeeId'] = $value_employeeId;
 ...
 */
	...
	public function member_modal() {
		...
		if ($this->input->post('slug') === 'create') {
			...
			$data['branch'] = $this->hr_profile_model->get_branch();
...
// multiple deparment
	...
	public function create_staff_sample_file() {
		...
		$header_key = [
			...
			'bhms_certificate_file',
			'bond_file',
			'cheque_scanned_file',
			'timing_effective_date',
			'eligible_ots',
			'ots_effective_date',
			'fixed_week_off',
			'week_off_on',
			'week_off_sat_sun',
			'week_off_effective_from',
			'pf_deduct',
			'pf_number',
			'pf_uan',
			'pt_deduct',
