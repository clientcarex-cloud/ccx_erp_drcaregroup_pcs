						...
						<div class="row">
							<div class="col-md-6">
								<?= render_select(
									...
									['id', 'name'],
									_l('branch'),
									isset($current_branch_id) ? $current_branch_id : ($member->branch_id ?? ''),
				  ...
				  <div role="tabpanel" class="tab-pane " id="tab_staff_related">
									...
									<div role="tabpanel" class="tab-pane " id="tab_staff_payroll">
										...
										<div class="form-group">
											...
											<select class="selectpicker" data-none-selected-text="<?php echo _l('hr_week_off_on'); ?>" data-width="100%" name="week_off_on" id="week_off_on" >
