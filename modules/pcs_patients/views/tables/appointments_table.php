...
foreach ($results as $aRow) {
    ...
    $row[] = pcs_get_treatments_by_userid($aRow['userid'], $aRow['appointment_id']);
...
// Helper functions (independent from client module)
function pcs_mask_last_5_digits($number)
{
...
function pcs_get_treatments_by_userid($userid, $id)
{
    $CI =& get_instance();
