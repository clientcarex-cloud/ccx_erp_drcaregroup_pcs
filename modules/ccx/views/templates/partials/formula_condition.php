    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="columns[<?= html_escape($columnIndex); ?>][formula_sources][<?= html_escape($sourceKey); ?>][conditions][field][]" class="form-control" value="<?= html_escape($fieldValue); ?>" placeholder="e.g. status">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label><?= html_escape(ccx_lang('ccx_template_condition_operator', 'Operator')); ?></label>
                <select name="columns[<?= html_escape($columnIndex); ?>][formula_sources][<?= html_escape($sourceKey); ?>][conditions][operator][]" class="form-control">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="columns[<?= html_escape($columnIndex); ?>][formula_sources][<?= html_escape($sourceKey); ?>][conditions][value][]" class="form-control" value="<?= html_escape($valueValue); ?>" placeholder="e.g. paid, 1,2,3 or {{column:col_1}}">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label><?= html_escape(ccx_lang('ccx_template_condition_type', 'Value Type')); ?></label>
                <select name="columns[<?= html_escape($columnIndex); ?>][formula_sources][<?= html_escape($sourceKey); ?>][conditions][type][]" class="form-control">
