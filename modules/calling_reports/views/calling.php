                                ...
                                <form method="post" id="filterForm">
                                    ...
                                    if ($type != "medicine_calling") {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label><input type="radio" name="date_filter" value="missed_calling"> Missed
                                                Calling</label>&nbsp;&nbsp;
                                            <label><input type="radio" name="date_filter" value="next_calling"> Next
                                                Calling</label>&nbsp;&nbsp;
                                            <label><input type="radio" name="date_filter" value="last_calling"> Last
                                                Calling</label>&nbsp;&nbsp;
                                            <?php
                                            if ($type == "renewal_calling") {
                                                ?>
                                                <label><input type="radio" name="date_filter" value="registration_end_date">
                                                    Registration End Date</label>
                                                <?php
                                            } else {
                                                ?>
                                                <label><input type="radio" name="date_filter" value="registration_date">
...
<script>
    ...
    <?php endif; ?>
            function loadCallingTable(filter, from_date, to_date, branchIds) {
                ...
                // New URL — points to calling_reports controller
                const url = '<?= admin_url("calling_reports/calling/$type/null/") ?>' + filter + '/' + from_date + '/' + to_date + '/' + branchIds;
