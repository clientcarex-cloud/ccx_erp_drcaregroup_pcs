...
class Calling_reports extends AdminController
{
    ...
    {
        // Default redirect to first calling type
        redirect(admin_url('calling_reports/calling/cpot_calling'));
    }
    ...
    public function calling($type, $id = NULL, $date_filter = NULL, $from_date = NULL, $to_date = NULL, $selected_branch_id = NULL)
    {
        ...
        if ($this->input->is_ajax_request()) {
            $this->app->get_table_data(module_views_path('calling_reports', 'tables/calling_table'), $data);
        }
        ...
        if ($id) {
            ...
            $callback_url = "calling_reports/calling/" . $type;
