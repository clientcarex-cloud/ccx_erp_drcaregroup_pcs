...
class Migration_Version_110 extends App_module_migration
{
	...
	{  
		...
		if($result){
			...
			if(strpos('top-header-links',$result->theme_style) == false)
				$theme_style[] = array('id'=>'top-header-links','color'=>'#c0c6d7');
			if(strpos('modal-heading-color',$result->theme_style) == false)
				$theme_style[] = array('id'=>'modal-heading-color','color'=>'#ffffff');
			if(strpos('text-muted',$result->theme_style) == false)
				$theme_style[] = array('id'=>'text-muted','color'=>'#c2c2c2');

			//add new fields alert related 	
			$theme_style[] = array('id'=>'alert-danger','color'=>'#b62626');
			$theme_style[] = array('id'=>'alert-warning','color'=>'#a16207');
			$theme_style[] = array('id'=>'alert-info','color'=>'#245cf8');	
			$theme_style[] = array('id'=>'alert-success','color'=>'#15803d');
			$theme_style[] = array('id'=>'alert-danger-background','color'=>'#362525');
			$theme_style[] = array('id'=>'alert-warning-background','color'=>'#383333');
			$theme_style[] = array('id'=>'alert-info-background','color'=>'#08232e');
			$theme_style[] = array('id'=>'alert-success-background','color'=>'#1e2c1e');
