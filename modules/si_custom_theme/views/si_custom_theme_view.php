								...
								<div class="panel_s">
									<div class="panel-body">
										...
										<div class="setting-color">
											...
											<?php } ?>
											<?php if($theme['theme_type'] !== 'custom'){?>
											<label>
											...
											<label>
												...
												<span class="icon-check"><i class="fa fa-check-circle"></i></span>
												<span class="split">
													<span class="color <?php echo ($theme['class'][0] == 'bg-custom' ? $theme['class'][0] : '')?>" style="background-color:<?php echo ($theme['class'][0] !== 'bg-custom' ? $theme['class'][0] : '');?>;"></span>
													<span class="color <?php echo ($theme['class'][1] == 'bg-custom' ? $theme['class'][1] : '')?>" style="background-color:<?php echo ($theme['class'][1] !== 'bg-custom' ? $theme['class'][1] : '');?>;"></span>
												</span>
												<span class="color <?php echo ($theme['class'][2] == 'bg-custom' ? $theme['class'][2] : '')?>"  style="background-color:<?php echo ($theme['class'][2] !== 'bg-custom' ? $theme['class'][2] : '');?>;"></span>
											</label>
											<?php } ?>
											<p class="text-center"><?php echo ($theme['theme_name']);?>
												<?php if($theme['theme_type'] == 'custom'){?>
												<a class="text-info" href="#" data-toggle="tooltip" data-title="<?php echo _l('edit'). ' ' . _l('si_custom_theme')?>" onclick="edit_custom_theme_name(<?php echo $theme['id']; ?>)"><i class="fa fa-pencil fa-regular fa-pen-to-square"></i></a>
												<?php }?>
											</p>
										</div>
										<?php }?>
								...
								<div class="panel_s">
									<div class="panel-body pickers">
										<div class="horizontal-scrollable-tabs">
											...
											<div class="horizontal-tabs">
												<ul class="nav nav-tabs no-margin nav-tabs-horizontal">
													...
													<li role="presentation">
														<a href="#tab_alerts_styling" aria-controls="tab_alerts_styling" role="tab" data-toggle="tab">
														<?php echo _l('si_ct_alerts'); ?>
														</a>
													</li>
													<li role="presentation">
										...
										<div class="tab-content">
											...
											<div role="tabpanel" class="tab-pane ptop10" id="tab_alerts_styling">
												<div class="row">
													<?php foreach(si_custom_theme_get_styling_areas('alerts') as $area){ ?>
													<div class="col-md-3">
														<label class="bold mbot10 inline-block"><?php echo ($area['name']); ?></label>
														<?php si_custom_theme_render_theme_styling_picker($area['id'],
														'',
...
<?php init_tail(); ?>
<div id="div_si_ct_edit_custom_theme_name"></div>
<script>
