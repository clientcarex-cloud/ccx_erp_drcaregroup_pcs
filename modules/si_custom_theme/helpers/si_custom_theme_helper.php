	...
	$areas = [
		'admin' => [
			...
			[
				...
				'css'                  => 'color',
				'additional_selectors' => '.sidebar-user-profile a span|color', // added .sidebar-user-profile a span|color for Perfex V3.2
			],
			[
			...
			[
				...
				'target' 				=> '
										...
										#side-menu.nav > li > a:hover .menu-icon', //added #side-menu li.active > a .menu-icon,#side-menu.nav > li > a:hover .menu-icon for Perfex V3.2
				'css'                  => 'color',
			...
			[
				...
				'target'               => '.admin #side-menu li .nav-second-level li a,.admin #setup-menu li .nav-second-level li a,
										.sidebar li .nav-second-level a:focus .menu-icon, .sidebar li .nav-second-level a:hover .menu-icon',
				'css'                  => 'color',
				'additional_selectors' => '',
			],
			[
			...
			[
				...
				'id'                   => 'top-header-links',
				'target'               => '.admin .navbar-nav > li > a, ul.mobile-icon-menu>li>a,.mobile-menu-toggle, .open-customizer-mobile,#top_search input[type=search],#top_search input::placeholder,.header-timers .tw-text-neutral-900,.header-notifications .tw-text-neutral-900,.navbar-nav .tw-bg-primary-600,.hide-menu, #top_search_button .tw-text-neutral-600, .header-timers .tw-text-neutral-400,.header-notifications .tw-text-neutral-400',//,#top_search input[type=search],#top_search input::placeholder,.header-timers .tw-text-neutral-900,.header-notifications .tw-text-neutral-900,.navbar-nav .tw-bg-primary-600,.hide-menu, #top_search_button .tw-text-neutral-600 for Perfex 3.0,  .header-timers .tw-text-neutral-400,.header-notifications .tw-text-neutral-400 for Perfex 3.2
				'css'                  => 'color',
				'additional_selectors' => '',
			],
		],
		'customers' => [
			[
				...
				'id'                   => 'customer-login-background',
				'target'               => 'body.customers_login,.customers .kb-search-jumbotron,.customers .jumbotron', //.customers .kb-search-jumbotron,.customers .jumbotron for Perfex V3.0
				'css'                  => 'background',
				'additional_selectors' => '',
			],
			[
		...
		'general' => [
			...
			[
				...
				'css'                  => 'background',
				'additional_selectors' => '.fn-gantt .bottom, .fn-gantt .leftPanel .desc, .fn-gantt .rightPanel .month, .fn-gantt .rightPanel .year, .fn-gantt .spacer, .fn-gantt .wd|background-color+#newsfeed|background-color',
			],
			[
				'name'                 => _l('si_ct_admin_page_text_color'),
				'id'                   => 'admin-page-text-color',
				'target'               => 'body,.input-group-addon,.form-control,.pagination>.disabled>a, .pagination>.disabled>a:focus, .pagination>.disabled>a:hover, .pagination>.disabled>span, .pagination>.disabled>span:focus, .pagination>.disabled>span:hover,.dataTables_empty,div.dataTables_wrapper div.dataTables_info, div.dataTables_wrapper div.dataTables_length label,.btn-default,.dropdown-menu li a,.filter-option-inner-inner,.control-label, label,.dropdown-menu>.active>a, .dropdown-menu>.active>a:focus, .dropdown-menu>.active>a:hover,.label-tag,.mce-menu-item .mce-ico, .mce-menu-item .mce-text,.gantt_project_name,.fn-gantt .leftPanel .fn-label,.fn-gantt .rightPanel .month,.fn-gantt .rightPanel .year,.fn-gantt .sa, .fn-gantt .sn,.fn-gantt .day, .fn-gantt .date,.dropdown-header,.table>tbody>tr>td .tw-text-neutral-700,.tw-text-neutral-700,.tw-text-neutral-600,.text-neutral-700,.tw-text-neutral-500,.fc .fc-col-header-cell-cushion,.tw-text-neutral-800', //added ,.table>tbody>tr>td .tw-text-neutral-700,.tw-text-neutral-700,.tw-text-neutral-600,.text-neutral-700,.tw-text-neutral-500,.fc .fc-col-header-cell-cushion,.tw-text-neutral-800 for Perfex V3.0
				'css'                  => 'color',
				'additional_selectors' => '.pagination>li>a, .pagination>li>span|color+.caret|border-color+.dataTables_wrapper table tbody a:not(.text-muted,.text-primary,.text-danger,.text-warning,.text-success,.text-info,.dropdown-toggle)|color', //added .caret|border-color for Perfex V3.0, added +.dataTables_wrapper table tbody a:not(.text-muted,.text-primary,.text-danger,.text-warning,.text-success,.text-info)|color for Perfex V3.2
			],
			[
			...
			[
				...
				'target'               => '.input-group-addon,.form-control,.pagination>.disabled>a, .pagination>.disabled>a:focus, .pagination>.disabled>a:hover, .pagination>.disabled>span, .pagination>.disabled>span:focus, .pagination>.disabled>span:hover,.dt-buttons.btn-group .btn,.dropdown-menu,.bootstrap-select .btn-default,.bootstrap-select .btn-default.disabled,textarea, .bg-stripe, form.dropzone, #dropzoneDragArea,.dropzoneDragArea, .mce-panel, .kan-ban-content, .email-template-heading,.dt-button-collection.dropdown-menu>li.active>a, .dt-button-collection.dropdown-menu>li>a:focus, .dt-button-collection.dropdown-menu>li>a:hover,.screen-options-area,.btn-default',
				'css'                  => 'border-color',
			...
			[
				...
				'id'                   => 'links-color',
				'target'               => 'a:not(.btn,.nav-tabs>li>a,.text-muted,.text-primary,.text-danger,.text-warning,.text-success,.text-info)',
				'css'                  => 'color',
				'additional_selectors' => '',
			],
			[
			...
			[
				...
				'target'               => '.panel .panel-heading,.panel .panel-body,.panel .panel-footer, .panel_s, .panel_s .panel-heading:not(.panel-heading-bg,.task-phase,.info-bg), .panel_s .panel-body, .panel_s .panel-footer,.list-group-item,.dt-button-collection.dropdown-menu>li>a,.top_stats_wrapper,.btn-bottom-toolbar,.authentication-form,.task-info-inline-input-edit,.screen-options-btn,.login_admin .tw-bg-white,.forgot-password .tw-bg-white',//,.login_admin .tw-bg-white,.forgot-password .tw-bg-white for Perfex V3.0
				'css'                  => 'background',
				'additional_selectors' => '.panel_s .panel-heading|border-color+.panel_s .panel-body|border-color+.panel_s .panel-footer|border-color+.panel_s|border-color+.top_stats_wrapper|border-color+.fn-gantt .sa, .fn-gantt .sn|background-color+.unread-notification,.notification-box.unread,.notification-box-all.unread|background-color',
			...
			[
				...
				'target'               => '.panel .panel-heading,.panel_s .panel-heading:not(.panel-heading-bg,.info-bg),.panel_s .panel-heading h4, .panel-heading h4,.panel-heading .panel-title a,.customer-profile-group-heading,.panel_s .panel-body h4:not(.panel-body .modal-title),.screen-options-btn,.login_admin h1,.forgot-password h1,h3.tw-text-neutral-900,.customers h3.tw-text-neutral-700,.customers h4.tw-text-neutral-700,h4.tw-text-neutral-700,h4.tw-text-neutral-700 span,h4.tw-text-neutral-800',//.login_admin h1,.forgot-password h1,h3.tw-text-neutral-900,.customers h3.tw-text-neutral-700,.customers h4.tw-text-neutral-700,h4.tw-text-neutral-700,h4.tw-text-neutral-700 span,h4.tw-text-neutral-800 for Perfex V3.0
				'css'                  => 'color',
				'additional_selectors' => '.customer-top-submenu li a|color+.customer-top-submenu li a:hover|color+h4 .caret|border-color',//.customer-top-submenu for client side,+h4 .caret|border-color for Perfex V3.0
		...
		'texts' => [
			...
			[
				'name'                 => _l('si_ct_text_dark'),
				'id'                   => 'text-dark',
				'target'               => '.text-dark',
				'css'                  => 'color',
				'additional_selectors' => '',
				'example'              => '<p>' . _l('si_ct_example_text', '<span class="bold text-dark">' . _l('si_ct_text_dark') . '</span>') . '</p>',
			],
		],
		'alerts' => [
			[
				'name'                 => _l('si_ct_alert_info'),
				'id'                   => 'alert-info',
				'target'               => '.alert-info',
				'css'                  => 'color',
				'additional_selectors' => '.alert-info hr|border-top-color',
				'example'              => '',
			],
			[
				'name'                 => _l('si_ct_alert_danger'),
				'id'                   => 'alert-danger',
				'target'               => '.alert-danger',
				'css'                  => 'color',
				'additional_selectors' => '.alert-danger hr|border-top-color',
				'example'              => '',
			],
			[
				'name'                 => _l('si_ct_alert_warning'),
				'id'                   => 'alert-warning',
				'target'               => '.alert-warning',
				'css'                  => 'color',
				'additional_selectors' => '.alert-warning hr|border-top-color',
				'example'              => '',
			],
			[
				'name'                 => _l('si_ct_alert_success'),
				'id'                   => 'alert-success',
				'target'               => '.alert-success',
				'css'                  => 'color',
				'additional_selectors' => '.alert-success hr|border-top-color',
				'example'              => '',
			],
			[
				'name'                 => _l('si_ct_alert_info_bg'),
				'id'                   => 'alert-info-background',
				'target'               => '.alert-info,li.task.current-user-task .panel-body, li.lead-kan-ban.current-user-lead .panel-body',
				'css'                  => 'background-color',
				'additional_selectors' => '',
				'example'              => '<p><span class="alert alert-info">' . _l('si_ct_example_text').': ' . _l('si_ct_alert_info') . '</span></p>',
			],
			[
				'name'                 => _l('si_ct_alert_danger_bg'),
				'id'                   => 'alert-danger-background',
				'target'               => '.alert-danger,li.task.overdue-task .panel-body',
				'css'                  => 'background-color',
				'additional_selectors' => '',
				'example'              => '<p><span class="alert alert-danger">' . _l('si_ct_example_text').': '. _l('si_ct_alert_danger') . '</span></p>',
			],
			[
				'name'                 => _l('si_ct_alert_warning_bg'),
				'id'                   => 'alert-warning-background',
				'target'               => '.alert-warning',
				'css'                  => 'background-color',
				'additional_selectors' => '',
				'example'              => '<p><span class="alert alert-warning">' . _l('si_ct_example_text').': ' . _l('si_ct_alert_warning') . '</span></p>',
			],
			[
				'name'                 => _l('si_ct_alert_success_bg'),
				'id'                   => 'alert-success-background',
				'target'               => '.alert-success',
				'css'                  => 'background-color',
				'additional_selectors' => '',
				'example'              => '<p><span class="alert alert-success">' . _l('si_ct_example_text').': ' . _l('si_ct_alert_success') . '</span></p>',
			],
		],
		'tabs' => [
			[
				...
				'id'                   => 'tabs-bg',
				'target'               => '.nav-tabs,.user-data .home-activity .nav.nav-tabs,.panel-full-width-tabs .nav li a, .panel-full-width-tabs.horizontal-scrollable-tabs .scroller, nav.customer-tabs ul',//added .panel-full-width-tabs .nav li a, .panel-full-width-tabs.horizontal-scrollable-tabs .scroller, nav.customer-tabs ul for Perfex V3.2
				'css'                  => 'background',
				'additional_selectors' => '',
			],
			[
				...
				'id'                   => 'tabs-links',
				'target'               => '.nav-tabs>li>a,.lead-info-heading h4,.user-data .home-activity .nav.nav-tabs>li>a, nav.customer-tabs>ul>li>a, nav.customer-tabs>ul>li>a>i', //added , nav.customer-tabs>ul>li>a, nav.customer-tabs>ul>li>a>i for Perfex V3.2
				'css'                  => 'color',
				'additional_selectors' => '',
			],
			[
		...
		'buttons' => [
			...
			[
				'name'                 => _l('si_ct_button_primary'),
				'id'                   => 'btn-primary',
				'target'               => '.btn-primary',
				'css'                  => 'background-color',
				'additional_selectors' => '.btn-primary|border-color',
				'example'              => '<button type="button" class="btn btn-primary">' . _l('si_ct_button_primary') . '</button>',
			],
			[
				'name'                 => _l('si_ct_button_info'),
				'id'                   => 'btn-info',
				'target'               => '.btn-info, body.customers_login .navbar-default .navbar-nav>li.customers-nav-item-login>a',//.btn-primary,body.customers_login .navbar-default .navbar-nav>li.customers-nav-item-login>a for Perfex V3.0
				'css'                  => 'background-color',
				'additional_selectors' => '.btn-info|border-color+.dropdown-menu>li>a:focus, .dropdown-menu>li>a:hover,.dropdown-menu>.active>a, .dropdown-menu>.active>a:focus, .dropdown-menu>.active>a:hover|background-color+.dropdown-menu1>li>a:not(.active):hover|color+.pagination>.active>a, .pagination>.active>a:focus, .pagination>.active>a:hover, .pagination>.active>span, .pagination>.active>span:focus, .pagination>.active>span:hover|background-color+.pagination>.active>a, .pagination>.active>a:focus, .pagination>.active>a:hover, .pagination>.active>span, .pagination>.active>span:focus, .pagination>.active>span:hover|border-color+.checkbox-info label::after,.checkbox-primary label::after,.radio-info label::after,.radio-primary label::after|background-color+.checkbox-info label::before,.checkbox-primary label::before,.radio-info  label::before,.radio-primary  label::before|border-color',
...
function si_custom_theme_render($type,$theme_id='')
{
		...
		foreach ($area as $_area) {
			foreach ($theme_style as $applied_style) {
				if ($applied_style->id == $_area['id']) {
					...
					if (strpos($_area['target'],'.alert-')!==false && strpos($_area['id'],'background')==false) {
						echo $_area['target'].'{' . PHP_EOL;
						echo 'border-color:' . $applied_style->color . '75 !important;}'. PHP_EOL;
							//here 75 is set for opacity of color.
					} 
	...
	//adds class in body tag to identify which theme is active. Which helps in adding custom CSS
	echo "<script>
			document.addEventListener('DOMContentLoaded', () => {
				document.body.classList.add('si_custom_theme_active_{$theme_id}');
			});
		</script>";
}
