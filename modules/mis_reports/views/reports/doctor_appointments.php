                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 d-flex align-items-end" style="margin-top: 26px;">
...
<script>
    $(document).ready(function () {
        ...
        $('#searchAppointmentsBtn').click(function () {
            ...
            const newUrl = `<?= admin_url("mis_reports/reports/doctor_appointments/null/") ?>${from}/${to}/${enquiry_doctor_id}/${visit_status}/${branch_id}/0/${appointment_type_id}`;
