                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control" id="consulted_date"
                                    value="<?= html_escape($consulted_date ?? date('Y-m-d')) ?>">
                            </div>
                            <div class="col-md-4">
                                <label>
                                    <?= _l('to_date'); ?>
                                ...
                                <input type="date" class="form-control" id="consulted_to_date"
                                    value="<?= html_escape($consulted_to_date ?? date('Y-m-d')) ?>">
                            </div>
                            <div class="col-md-2" style="margin-top: 24px;">
                                <button class="btn btn-success" id="searchAppointmentsBtn">
                                    <?= _l('search'); ?>
                                </button>
                            </div>
                        </div>
    ...
    $(function () {
        function loadBranchPaymentTable() {
            ...
            if ($.fn.DataTable.isDataTable('.table-appointments')) {
                ...
                initDataTable('.table-appointments', `<?= admin_url("mis_reports/reports/$type/1/") ?>${from}/${to}`, [1], [1]);
            }
        }
