...
<form method="post" action="<?= admin_url('mis_reports/reports/cro_ownership_report'); ?>">
...
$(function(){
    ...
    initDataTable('#branchReportTable', '<?= admin_url("mis_reports/reports/$type/1/") ?>' + consulted_date + '/' + consulted_to_date, [1], [1]); */
});
