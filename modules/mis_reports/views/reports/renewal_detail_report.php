...
$(function(){
    function loadAppointmentsTable() {
        ...
        var baseUrl = '<?= admin_url("mis_reports/reports") ?>';

        var ajaxUrl = `${baseUrl}/${type}/1/${consulted_date}/${consulted_to_date}/${appointment_type}/${selected_branch_id}/${doctor_id}/${category}`;
