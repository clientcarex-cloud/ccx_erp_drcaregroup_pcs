			...
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						...
						<?php
						$default_url = admin_url('mis_reports/reports/mis_reports');
						...
						if (staff_can('doctor_reports', 'customers')) {
							$mis_sections['Doctors'][] = ['Doctor Ownership Report', 'Patients tagged under doctors.', admin_url('mis_reports/reports/doctor_ownership_reports')];

							$mis_sections['Doctors'][] = ['Appointment Report', 'Detailed appointment statistics.', admin_url('mis_reports/reports/appointment_report')];

							$mis_sections['Doctors'][] = ['Consultation Fee Report', 'Consultation fee collection per doctor.', admin_url('mis_reports/reports/consult_fee_report')];

							$mis_sections['Doctors'][] = ['Doctor Appointment List Report', 'List of appointments per doctor.', admin_url('mis_reports/reports/doctor_appointment_list_report')];


							$mis_sections['Doctors'][] = ['Doctor Appointment Report', 'Appointment status per doctor.', admin_url('mis_reports/reports/doctor_appointment_report')];

							$mis_sections['Doctors'][] = ['Enquiry Doctor Ownership Report Details', 'Enquiry Doctor Ownership Report Details.', admin_url('mis_reports/reports/enquiry_doctor_ownership_detail_report')];
						}
						if (staff_can('admin_reports', 'customers')) {
							$mis_sections['Admin'][] = ['Branch Registration Report', 'New registrations by branch.', admin_url('mis_reports/reports/branch_registration_report')];

							$mis_sections['Admin'][] = ['Payment Detail Report', 'Payment Detail Report', admin_url('mis_reports/reports/payment_detail_report')];
						}

						if (staff_can('cce_reports', 'customers')) {

							$mis_sections['CCE'][] = ['My Appointments Report', 'Appointments created by me.', admin_url('mis_reports/reports/my_appointment_report_cc')];

							$mis_sections['CCE'][] = ['Appointment Report (CC)', 'Center-wise appointment stats.', admin_url('mis_reports/reports/appointment_report_cc')];

							$mis_sections['CCE'][] = ['Enquiry Call Report', 'Enquiry Call Report', admin_url('mis_reports/reports/enquiry_call_report')];
						}

						if (staff_can('cse_reports', 'customers')) {

							$mis_sections['CSE'][] = ['CSE GT Report', 'CSE GT Report', admin_url('mis_reports/reports/cse_gt_report')];

							$mis_sections['CSE'][] = ['My Ownership Report', 'My Ownership Report', admin_url('mis_reports/reports/cse_ownership_report')];
						}

						if (staff_can('sales_reports', 'customers')) {
							$mis_sections['Sales'][] = ['Branch Payment Report', 'Payments collected across branches.', admin_url('mis_reports/reports/branch_payment_report')];

							$mis_sections['Sales'][] = ['CRO Ownership Report', 'Patients owned by CROs.', admin_url('mis_reports/reports/cro_ownership_report')];
						}

						if (staff_can('other_reports', 'customers')) {

							$mis_sections['Other Reports'][] = ['Renewal Report', 'Patient treatment renewal report', admin_url('mis_reports/reports/renewal_report')];

							$mis_sections['Other Reports'][] = ['Enquiry GT Report', 'Enquiry GT Report', admin_url('mis_reports/reports/enquiry_gt_report')];

							$mis_sections['Other Reports'][] = ['GT Report', 'GT Report', admin_url('mis_reports/reports/gt_report')];

							$mis_sections['Other Reports'][] = ['Casesheet Patient Status Report', 'Casesheet Patient Status Report', admin_url('mis_reports/reports/casesheet_patient_status_report')];

							$mis_sections['Other Reports'][] = ['Source Enquiry Report', 'Source Enquiry Report', admin_url('mis_reports/reports/source_enquiry_report')];

							$mis_sections['Other Reports'][] = ['CRO Ownership Detail Report', 'CRO Ownership Detail Report', admin_url('mis_reports/reports/cro_ownership_detail_report')];

							$mis_sections['Other Reports'][] = ['Pharmacy Report', 'Medicine distribution and inventory tracking.', admin_url('mis_reports/reports/pharmacy_report')];
						...
						if (staff_can('manager_reports', 'customers')) {
							...
							$mis_sections['Managers'][] = ['TAT Report', 'Turnaround Time for services.', admin_url('mis_reports/reports/tat_report')];
						}

						if (staff_can('productivity_reports', 'customers')) {

							$mis_sections['Productivity'][] = ['Task Count Report', 'Task Count Report', admin_url('mis_reports/reports/task_count')];

							$mis_sections['Productivity'][] = ['Date wise Delegation Report', 'Date wise Delegation Report', admin_url('mis_reports/reports/datewise_delegation')];

							$mis_sections['Productivity'][] = ['Task Category Count', 'Task Category Wise Count', admin_url('mis_reports/reports/task_category_count')];

							$mis_sections['Productivity'][] = ['Overall Productivity Status Report', 'Overall Productivity Status Report', admin_url('mis_reports/reports/overall_productivity_status')];

							$mis_sections['Productivity'][] = ['Task Ontime Report', 'Overall Productivity Status Report', admin_url('mis_reports/reports/task_ontime')];
						}
