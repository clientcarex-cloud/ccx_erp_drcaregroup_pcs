...
foreach ($results as $row) {
    ...
    // Base URL params
    $base_url = admin_url("mis_reports/reports/branch_summary_details?");
    $id                = 'NULL';
    ...
    $output['data'][] = [
		...
		// Visits → clickable
		'<a style="color: blue" href="' . admin_url("mis_reports/reports/enquiry_gt_detail_report/{$id}/{$consulted_from_date}/{$consulted_to_date}/{$appointment_type}/{$branch_id}/{$doctor_id}/visit_np/{$lead_sourceIds}") . '" target="_blank">' . $visit_np . '</a>',
		'<a style="color: blue" href="' . admin_url("mis_reports/reports/enquiry_gt_detail_report/{$id}/{$consulted_from_date}/{$consulted_to_date}/{$appointment_type}/{$branch_id}/{$doctor_id}/visit_ref/{$lead_sourceIds}") . '" target="_blank">' . $visit_ref . '</a>',
		'<a style="color: blue" href="' . admin_url("mis_reports/reports/enquiry_gt_detail_report/{$id}/{$consulted_from_date}/{$consulted_to_date}/{$appointment_type}/{$branch_id}/{$doctor_id}/visit_total/{$lead_sourceIds}") . '" target="_blank">' . $visit_total . '</a>',

		// Registrations → clickable
		'<a style="color: blue" href="' . admin_url("mis_reports/reports/enquiry_gt_detail_report/{$id}/{$consulted_from_date}/{$consulted_to_date}/{$appointment_type}/{$branch_id}/{$doctor_id}/reg_np/{$lead_sourceIds}") . '" target="_blank">' . $reg_np . '</a>',
		'<a style="color: blue" href="' . admin_url("mis_reports/reports/enquiry_gt_detail_report/{$id}/{$consulted_from_date}/{$consulted_to_date}/{$appointment_type}/{$branch_id}/{$doctor_id}/reg_ref/{$lead_sourceIds}") . '" target="_blank">' . $reg_ref . '</a>',
		'<a style="color: blue" href="' . admin_url("mis_reports/reports/enquiry_gt_detail_report/{$id}/{$consulted_from_date}/{$consulted_to_date}/{$appointment_type}/{$branch_id}/{$doctor_id}/reg_total/{$lead_sourceIds}") . '" target="_blank">' . $reg_total . '</a>',
