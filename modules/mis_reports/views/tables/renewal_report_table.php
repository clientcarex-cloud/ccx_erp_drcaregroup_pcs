...
foreach ($branches as $branch) {
    ...
    $data[] = [
        $branch_name,
        '<a style="color: blue" href="' . admin_url("mis_reports/reports/renewal_summary_details/NULL/{$from_date}/{$to_date}/NULL/{$branch_id}/NULL/total_renewals/NULL") . '" target="_blank">' . $total_renewals . '</a>',
        //'<a style="color: blue" href="' . admin_url("mis_reports/reports/renewal_summary_details/NULL/{$from_date}/{$to_date}/NULL/{$branch_id}/NULL/expected_active_renewals/NULL") . '" target="_blank">' . $expected_active_renewals . '</a>',
        '<a style="color: blue" href="' . admin_url("mis_reports/reports/renewal_summary_details/NULL/{$from_date}/{$to_date}/NULL/{$branch_id}/NULL/active_renewals/NULL") . '" target="_blank">' . $active_renewals . '</a>',
        '<a style="color: blue" href="' . admin_url("mis_reports/reports/renewal_summary_details/NULL/{$from_date}/{$to_date}/NULL/{$branch_id}/NULL/inactive_renewals/NULL") . '" target="_blank">' . $inactive_renewals . '</a>',
        /* '<a style="color: blue" href="' . admin_url("mis_reports/reports/renewal_summary_details/NULL/{$from_date}/{$to_date}/NULL/{$branch_id}/NULL/visited_clients/NULL") . '" target="_blank">' . $visited_clients . '</a>',
        '<a style="color: blue" href="' . admin_url("mis_reports/reports/renewal_summary_details/NULL/{$from_date}/{$to_date}/NULL/{$branch_id}/NULL/reg_clients/NULL") . '" target="_blank">' . $reg_clients . '</a>', */
		//$visited_clients,
		//$reg_clients,
