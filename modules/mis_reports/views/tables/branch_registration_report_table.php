...
foreach ($branches as $branch) {
    ...
    $data[] = [
		...
		'<a href="' . admin_url("mis_reports/reports/branch_registration_detail_report/NULL/{$from_date}/{$to_date}/NULL/{$branch_id}/NULL/all") . '" target="_blank">' . $total_registrations .'</a>',

		'<a href="' . admin_url("mis_reports/reports/branch_registration_detail_report/NULL/{$from_date}/{$to_date}/NULL/{$branch_id}/NULL/reference") . '" target="_blank">' . count($ref_client_ids) . '</a>',

		number_format($ref_package, 2),
		number_format($ref_paid, 2),
		number_format($ref_due, 2),

		'<a href="' . admin_url("mis_reports/reports/branch_registration_detail_report/NULL/{$from_date}/{$to_date}/NULL/{$branch_id}/NULL/walkin") . '" target="_blank">' . count($walkin_ids) . '</a>',

		number_format($walkin_package, 2),
		number_format($walkin_paid, 2),
		number_format($walkin_due, 2),

		'<a href="' . admin_url("mis_reports/reports/branch_registration_detail_report/NULL/{$from_date}/{$to_date}/NULL/{$branch_id}/NULL/renewal") . '" target="_blank">' . count($renewal_ids) . '</a>',
		...
		number_format($renewal_due, 2),
		  ...
		  // ✅ CCE
        '<a href="' . admin_url("mis_reports/reports/branch_registration_detail_report/NULL/{$from_date}/{$to_date}/NULL/{$branch_id}/NULL/cce") . '" target="_blank">' . count($cce_client_ids) . '</a>',
        number_format($cce_package, 2),
        number_format($cce_paid, 2),
        number_format($cce_due, 2),
		
		// ✅ new OTHER category
		'<a href="' . admin_url("mis_reports/reports/branch_registration_detail_report/NULL/{$from_date}/{$to_date}/NULL/{$branch_id}/NULL/other") . '" target="_blank">' . count($other_ids) . '</a>',
