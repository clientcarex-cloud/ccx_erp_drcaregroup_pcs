...
$where = [];
$where[] = "AND l.refer_type = 'patient'";
...
// Cache patient names
$patients_result = $CI->db->select('userid, company')->get(db_prefix() . 'clients')->result_array();
$patient_map = [];
foreach ($patients_result as $p) {
    $patient_map[$p['userid']] = $p['company'];
}
